defmodule Analytics do
  ...
  **Content Types**: `application/json`
  ...
  """
  @spec create_analytics_rule(body :: AnalyticsRuleSchema.t(), opts :: keyword) ::
  ...
  """
  @spec delete_analytics_rule(ruleName :: String.t(), opts :: keyword) ::
          {:ok, AnalyticsRuleSchema.t()} | {:error, ApiResponse.t()}
  ...
  """
  @spec retrieve_analytics_rule(ruleName :: String.t(), opts :: keyword) ::
          {:ok, AnalyticsRuleSchema.t()} | {:error, ApiResponse.t()}
  ...
  @spec retrieve_analytics_rules(opts :: keyword) ::
          {:ok, AnalyticsRulesRetrieveSchema.t()} | :error
