defmodule Stopwords do
  ...
  @spec delete_stopwords_set(setId :: String.t(), opts :: keyword) ::
          {:ok, Stopwords.delete_stopwords_set_200_json_resp()} | {:error, ApiResponse.t()}
  ...
  """
  @spec retrieve_stopwords_sets(opts :: keyword) :: {:ok, StopwordsSetRetrieveSchema.t()} | :error
  ...
  @spec upsert_stopwords_set(
          setId :: String.t(),
          body :: StopwordsSetUpsertSchema.t(),
          opts :: keyword
