defmodule Documents do
  ...
  @spec delete_documents(collectionName :: String.t(), opts :: keyword) ::
          {:ok, Documents.delete_documents_200_json_resp()} | {:error, ApiResponse.t()}
  ...
  @spec get_search_overrides(collectionName :: String.t(), opts :: keyword) ::
          {:ok, SearchOverridesResponse.t()} | :error
  ...
  **Content Types**: `application/json`
  """
  @spec multi_search(body :: MultiSearchSearchesParameter.t(), opts :: keyword) ::
  ...
  **Content Types**: `application/json`
  ...
  @spec update_documents(collectionName :: String.t(), body :: map, opts :: keyword) ::
          {:ok, Documents.update_documents_200_json_resp()} | {:error, ApiResponse.t()}
