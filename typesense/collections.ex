defmodule Collections do
  ...
  **Content Types**: `application/json`
  ...
  """
  @spec create_collection(body :: CollectionSchema.t(), opts :: keyword) ::
  ...
  """
  @spec get_aliases(opts :: keyword) :: {:ok, CollectionAliasesResponse.t()} | :error
  ...
  """
  @spec get_collections(opts :: keyword) :: {:ok, [CollectionResponse.t()]} | :error
  ...
  **Content Types**: `application/json`
  ...
  """
  @spec upsert_alias(aliasName :: String.t(), body :: CollectionAliasSchema.t(), opts :: keyword) ::
          {:ok, CollectionAlias.t()} | {:error, ApiResponse.t()}
