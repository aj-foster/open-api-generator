defmodule Typesense.Operations do
  @moduledoc """
  ...
  """
  @spec take_snapshot(opts :: keyword) :: {:ok, Typesense.SuccessStatus.t()} | :error
  def take_snapshot(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Typesense.Operations, :take_snapshot},
      url: "/operations/snapshot",
      method: :post,
      query: query,
      response: [{201, {Typesense.SuccessStatus, :t}}],
      opts: opts
    })
  end
  ...
  """
  @spec vote(opts :: keyword) :: {:ok, Typesense.SuccessStatus.t()} | :error
  def vote(opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [],
      call: {Typesense.Operations, :vote},
      url: "/operations/vote",
      method: :post,
      response: [{200, {Typesense.SuccessStatus, :t}}],
      opts: opts
    })
  end
end
