defmodule Discord.KeywordUpsertRequest do
  @moduledoc """
  Provides struct and type for a KeywordUpsertRequest
  """
  ...
  @type t :: %__MODULE__{
          ...
          name: String.t(),
          trigger_metadata: Discord.KeywordTriggerMetadata.t() | nil,
          trigger_type: 1
        }
  ...
  def __fields__(:t) do
    [
      ...
      name: :string,
      trigger_metadata: {:union, [{Discord.KeywordTriggerMetadata, :t}, :null]},
