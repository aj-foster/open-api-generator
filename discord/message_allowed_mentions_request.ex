defmodule Discord.MessageAllowedMentionsRequest do
  @moduledoc """
  ...
  def __fields__(:t) do
    [
      parse: {:union, [[union: [:string, :null]], :null]},
      replied_user: {:union, [:boolean, :null]},
      roles: {:union, [[union: [{:string, "snowflake"}, :null]], :null]},
      users: {:union, [[union: [{:string, "snowflake"}, :null]], :null]}
    ]
  end
end
