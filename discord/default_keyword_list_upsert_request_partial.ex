defmodule Discord.DefaultKeywordListUpsertRequestPartial do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          name: String.t() | nil,
          trigger_metadata: Discord.DefaultKeywordListTriggerMetadata.t() | nil,
          trigger_type: 4 | nil
        }
  ...
  def __fields__(:t) do
    [
      ...
      name: :string,
      trigger_metadata: {Discord.DefaultKeywordListTriggerMetadata, :t},
