defmodule Discord.PrivateApplicationResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          slug: String.t() | nil,
          tags: [String.t()] | nil,
          team: Discord.TeamResponse.t() | nil,
  ...
  def __fields__(:t) do
    [
      approximate_guild_count: {:union, [:integer, :null]},
      ...
      team: {:union, [{Discord.TeamResponse, :t}, :null]},
