defmodule Discord.GuildRoleTagsResponse do
  @moduledoc """
  ...
  def __fields__(:t) do
    [
      ...
      bot_id: {:union, [{:string, "snowflake"}, :null]},
      guild_connections: :null,
      integration_id: {:union, [{:string, "snowflake"}, :null]},
      premium_subscriber: :null,
      subscription_listing_id: {:union, [{:string, "snowflake"}, :null]}
    ]
  end
end
