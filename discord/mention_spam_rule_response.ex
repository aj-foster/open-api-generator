defmodule Discord.MentionSpamRuleResponse do
  @moduledoc """
  Provides struct and type for a MentionSpamRuleResponse
  """
  ...
  @type t :: %__MODULE__{
          ...
          id: String.t(),
          name: String.t(),
          trigger_metadata: Discord.MentionSpamTriggerMetadataResponse.t(),
          trigger_type: 5
        }
