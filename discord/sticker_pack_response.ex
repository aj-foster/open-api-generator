defmodule Discord.StickerPackResponse do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          name: String.t(),
          sku_id: String.t(),
          stickers: [Discord.StandardStickerResponse.t()]
        }
  ...
  def __fields__(:t) do
    [
      banner_asset_id: {:union, [{:string, "snowflake"}, :null]},
      cover_sticker_id: {:union, [{:string, "snowflake"}, :null]},
