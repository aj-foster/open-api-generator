defmodule CreatedThreadResponse do
  @moduledoc """
  Provides struct and type for a CreatedThreadResponse
  """
  ...
  @type t :: %__MODULE__{
          ...
          member: ThreadMemberResponse.t() | nil,
          ...
          thread_metadata: ThreadMetadataResponse.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      member: {:union, [{ThreadMemberResponse, :t}, :null]},
      member_count: :integer,
      message_count: :integer,
      name: {:string, :generic},
      ...
      thread_metadata: {:union, [{ThreadMetadataResponse, :t}, :null]},
      total_message_sent: :integer,
      type: {:enum, ~c"
"},
