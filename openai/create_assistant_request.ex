defmodule OpenAI.CreateAssistantRequest do
  @moduledoc """
  Provides struct and type for a CreateAssistantRequest
  """
  ...
  @type t :: %__MODULE__{
          ...
          tool_resources: OpenAI.CreateAssistantRequestToolResources.t() | nil,
          tools:
            [
  ...
  def __fields__(:t) do
    [
      ...
      temperature: :number,
      tool_resources: {OpenAI.CreateAssistantRequestToolResources, :t},
      tools: [
        union: [
          {OpenAI.AssistantToolsCode, :t},
          {OpenAI.AssistantToolsFileSearch, :t},
