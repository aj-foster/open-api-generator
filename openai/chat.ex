defmodule Chat do
  ...
  **Starting a new project?** We recommend trying [Responses](/docs/api-reference/responses) 
  ...
  """
  @spec create_chat_completion(body :: CreateChatCompletionRequest.t(), opts :: keyword) ::
          {:ok, CreateChatCompletionResponse.t() | CreateChatCompletionStreamResponse.t()}
          | :error
  def create_chat_completion(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Chat, :create_chat_completion},
      url: "/chat/completions",
      body: body,
      method: :post,
      request: [{"application/json", {CreateChatCompletionRequest, :t}}],
      response: [
        {200,
         {:union, [{CreateChatCompletionResponse, :t}, {CreateChatCompletionStreamResponse, :t}]}}
      ],
      opts: opts
    })
  end
  ...
  @spec get_chat_completion(completion_id :: String.t(), opts :: keyword) ::
          {:ok, CreateChatCompletionResponse.t()} | :error
  def get_chat_completion(completion_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [completion_id: completion_id],
      call: {Chat, :get_chat_completion},
      url: "/chat/completions/#{completion_id}",
      method: :get,
      response: [{200, {CreateChatCompletionResponse, :t}}],
      opts: opts
    })
  end
  ...
  @spec get_chat_completion_messages(completion_id :: String.t(), opts :: keyword) ::
          {:ok, ChatCompletionMessageList.t()} | :error
  def get_chat_completion_messages(completion_id, opts \\ []) do
    ...
    client.request(%{
      args: [completion_id: completion_id],
      call: {Chat, :get_chat_completion_messages},
      url: "/chat/completions/#{completion_id}/messages",
      method: :get,
      query: query,
      response: [{200, {ChatCompletionMessageList, :t}}],
      opts: opts
    })
  end
  ...
  """
  @spec list_chat_completions(opts :: keyword) :: {:ok, ChatCompletionList.t()} | :error
  def list_chat_completions(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Chat, :list_chat_completions},
      url: "/chat/completions",
      method: :get,
      query: query,
      response: [{200, {ChatCompletionList, :t}}],
      opts: opts
    })
  end
  ...
  def update_chat_completion(completion_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Chat, :update_chat_completion},
      url: "/chat/completions/#{completion_id}",
      body: body,
      method: :post,
