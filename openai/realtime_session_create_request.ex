defmodule RealtimeSessionCreateRequest do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          input_audio_transcription:
            RealtimeSessionCreateRequestInputAudioTranscription.t() | nil,
          ...
          tools: [RealtimeSessionCreateRequestTools.t()] | nil,
          turn_detection: RealtimeSessionCreateRequestTurnDetection.t() | nil,
          voice: String.t() | nil
        }
  ...
  def __fields__(:t) do
    [
      ...
      input_audio_transcription: {RealtimeSessionCreateRequestInputAudioTranscription, :t},
      ...
      tools: [{RealtimeSessionCreateRequestTools, :t}],
      turn_detection: {RealtimeSessionCreateRequestTurnDetection, :t},
