defmodule CreateCompletionResponseChoicesLogprobs do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          tokens: [String.t()] | nil,
          top_logprobs: [CreateCompletionResponseChoicesLogprobsTopLogprobs.t()] | nil
        }
  ...
  def __fields__(:t) do
    [
      ...
      top_logprobs: [{CreateCompletionResponseChoicesLogprobsTopLogprobs, :t}]
    ]
  end
end
