defmodule Files do
  ...
  """
  @spec create_file(body :: CreateFileRequest.t(), opts :: keyword) ::
          {:ok, OpenAIFile.t()} | :error
  def create_file(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Files, :create_file},
      url: "/files",
      body: body,
      method: :post,
      request: [{"multipart/form-data", {CreateFileRequest, :t}}],
      response: [{200, {OpenAIFile, :t}}],
      opts: opts
    })
  end
  ...
  @spec delete_file(file_id :: String.t(), opts :: keyword) ::
          {:ok, DeleteFileResponse.t()} | :error
  def delete_file(file_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [file_id: file_id],
      call: {Files, :delete_file},
      url: "/files/#{file_id}",
      method: :delete,
      response: [{200, {DeleteFileResponse, :t}}],
      opts: opts
    })
  end
  ...
  """
  @spec list_files(opts :: keyword) :: {:ok, ListFilesResponse.t()} | :error
  def list_files(opts \\ []) do
    ...
    client.request(%{
      ...
      method: :get,
      query: query,
      response: [{200, {ListFilesResponse, :t}}],
      opts: opts
    })
  end
  ...
  """
  @spec retrieve_file(file_id :: String.t(), opts :: keyword) :: {:ok, OpenAIFile.t()} | :error
  def retrieve_file(file_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [file_id: file_id],
      call: {Files, :retrieve_file},
      url: "/files/#{file_id}",
      method: :get,
      response: [{200, {OpenAIFile, :t}}],
      opts: opts
