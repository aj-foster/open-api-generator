defmodule Operations do
  ...
  """
  @spec admin_api_keys_create(body :: map, opts :: keyword) :: {:ok, AdminApiKey.t()} | :error
  def admin_api_keys_create(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Operations, :admin_api_keys_create},
      url: "/organization/admin_api_keys",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [{200, {AdminApiKey, :t}}],
      opts: opts
    })
  end
  ...
  """
  @spec admin_api_keys_delete(key_id :: String.t(), opts :: keyword) :: {:ok, map} | :error
  def admin_api_keys_delete(key_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [key_id: key_id],
      call: {Operations, :admin_api_keys_delete},
      url: "/organization/admin_api_keys/#{key_id}",
      method: :delete,
      response: [{200, {Operations, :admin_api_keys_delete_200_json_resp}}],
      opts: opts
    })
  end
  ...
  @spec admin_api_keys_get(key_id :: String.t(), opts :: keyword) ::
          {:ok, AdminApiKey.t()} | :error
  def admin_api_keys_get(key_id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [key_id: key_id],
      call: {Operations, :admin_api_keys_get},
      url: "/organization/admin_api_keys/#{key_id}",
      method: :get,
      response: [{200, {AdminApiKey, :t}}],
      opts: opts
  ...
  """
  @spec admin_api_keys_list(opts :: keyword) :: {:ok, ApiKeyList.t()} | :error
  def admin_api_keys_list(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Operations, :admin_api_keys_list},
      url: "/organization/admin_api_keys",
      method: :get,
      query: query,
      response: [{200, {ApiKeyList, :t}}],
      opts: opts
    })
  end
