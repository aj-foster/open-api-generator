defmodule AuditLogs do
  ...
  """
  @spec list_audit_logs(opts :: keyword) :: {:ok, ListAuditLogsResponse.t()} | :error
  def list_audit_logs(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {AuditLogs, :list_audit_logs},
      url: "/organization/audit_logs",
      method: :get,
      query: query,
      response: [{200, {ListAuditLogsResponse, :t}}],
      opts: opts
    })
  end
end
