defmodule Usage do
  ...
  """
  @spec usage_audio_speeches(opts :: keyword) :: {:ok, UsageResponse.t()} | :error
  def usage_audio_speeches(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Usage, :usage_audio_speeches},
      url: "/organization/usage/audio_speeches",
      method: :get,
      query: query,
      response: [{200, {UsageResponse, :t}}],
      opts: opts
    })
  end
  ...
  """
  @spec usage_audio_transcriptions(opts :: keyword) :: {:ok, UsageResponse.t()} | :error
  def usage_audio_transcriptions(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Usage, :usage_audio_transcriptions},
  ...
  """
  @spec usage_code_interpreter_sessions(opts :: keyword) :: {:ok, UsageResponse.t()} | :error
  def usage_code_interpreter_sessions(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Usage, :usage_code_interpreter_sessions},
  ...
  """
  @spec usage_completions(opts :: keyword) :: {:ok, UsageResponse.t()} | :error
  ...
  """
  @spec usage_costs(opts :: keyword) :: {:ok, UsageResponse.t()} | :error
  ...
  """
  @spec usage_embeddings(opts :: keyword) :: {:ok, UsageResponse.t()} | :error
  ...
  """
  @spec usage_images(opts :: keyword) :: {:ok, UsageResponse.t()} | :error
  ...
  """
  @spec usage_moderations(opts :: keyword) :: {:ok, UsageResponse.t()} | :error
  ...
  """
  @spec usage_vector_stores(opts :: keyword) :: {:ok, UsageResponse.t()} | :error
  def usage_vector_stores(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Usage, :usage_vector_stores},
