defmodule StabilityAI.Generate do
  @moduledoc """
  ...
  **Content Types**: `multipart/form-data`
  """
  @spec v2_beta_stable_image_generate_core_post(body :: map, opts :: keyword) ::
          {:ok, binary | StabilityAI.Generate.v2_beta_stable_image_generate_core_post_200__resp()}
          | {:error,
             StabilityAI.ContentModerationResponse.t()
             | StabilityAI.Generate.v2_beta_stable_image_generate_core_post_400_json_resp()
             | StabilityAI.Generate.v2_beta_stable_image_generate_core_post_422_json_resp()
             | StabilityAI.Generate.v2_beta_stable_image_generate_core_post_429_json_resp()
             | StabilityAI.Generate.v2_beta_stable_image_generate_core_post_500_json_resp()}
  def v2_beta_stable_image_generate_core_post(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {StabilityAI.Generate, :v2_beta_stable_image_generate_core_post},
      ...
      response: [
        {200,
         {:union,
          [
            {StabilityAI.Generate, :v2_beta_stable_image_generate_core_post_200__resp},
            string: "binary"
          ]}},
        {400, {StabilityAI.Generate, :v2_beta_stable_image_generate_core_post_400_json_resp}},
        {403, {StabilityAI.ContentModerationResponse, :t}},
        {422, {StabilityAI.Generate, :v2_beta_stable_image_generate_core_post_422_json_resp}},
        {429, {StabilityAI.Generate, :v2_beta_stable_image_generate_core_post_429_json_resp}},
        {500, {StabilityAI.Generate, :v2_beta_stable_image_generate_core_post_500_json_resp}}
      ],
      opts: opts
    })
  end
  ...
  **Content Types**: `multipart/form-data`
  """
  @spec v2_beta_stable_image_generate_sd3_post(
          body :: StabilityAI.ImageToImage.t() | StabilityAI.TextToImage.t(),
          opts :: keyword
        ) ::
          {:ok, binary | StabilityAI.Generate.v2_beta_stable_image_generate_sd3_post_200__resp()}
          | {:error,
             StabilityAI.ContentModerationResponse.t()
             | StabilityAI.Generate.v2_beta_stable_image_generate_sd3_post_400_json_resp()
             | StabilityAI.Generate.v2_beta_stable_image_generate_sd3_post_413_json_resp()
             | StabilityAI.Generate.v2_beta_stable_image_generate_sd3_post_422_json_resp()
             | StabilityAI.Generate.v2_beta_stable_image_generate_sd3_post_429_json_resp()
             | StabilityAI.Generate.v2_beta_stable_image_generate_sd3_post_500_json_resp()}
  def v2_beta_stable_image_generate_sd3_post(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {StabilityAI.Generate, :v2_beta_stable_image_generate_sd3_post},
      url: "/v2beta/stable-image/generate/sd3",
      body: body,
      method: :post,
      request: [
        {"multipart/form-data",
         {:union, [{StabilityAI.ImageToImage, :t}, {StabilityAI.TextToImage, :t}]}}
      ],
      response: [
        {200,
         {:union,
          [
            {StabilityAI.Generate, :v2_beta_stable_image_generate_sd3_post_200__resp},
            string: "binary"
          ]}},
        {400, {StabilityAI.Generate, :v2_beta_stable_image_generate_sd3_post_400_json_resp}},
        {403, {StabilityAI.ContentModerationResponse, :t}},
        {413, {StabilityAI.Generate, :v2_beta_stable_image_generate_sd3_post_413_json_resp}},
        {422, {StabilityAI.Generate, :v2_beta_stable_image_generate_sd3_post_422_json_resp}},
        {429, {StabilityAI.Generate, :v2_beta_stable_image_generate_sd3_post_429_json_resp}},
        {500, {StabilityAI.Generate, :v2_beta_stable_image_generate_sd3_post_500_json_resp}}
      ],
      opts: opts
    })
  end
