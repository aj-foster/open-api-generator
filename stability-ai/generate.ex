defmodule Generate do
  ...
  **Content Types**: `multipart/form-data`
  ...
  @spec v2_beta_stable_image_generate_core_post(body :: map, opts :: keyword) ::
          {:ok, Generate.v2_beta_stable_image_generate_core_post_200__resp() | String.t()}
          | {:error,
             ContentModerationResponse.t()
             | Generate.v2_beta_stable_image_generate_core_post_400_json_resp()
             | Generate.v2_beta_stable_image_generate_core_post_422_json_resp()
             | Generate.v2_beta_stable_image_generate_core_post_429_json_resp()
             | Generate.v2_beta_stable_image_generate_core_post_500_json_resp()}
  ...
  **Content Types**: `multipart/form-data`
  ...
  @spec v2_beta_stable_image_generate_sd3_post(
          body :: ImageToImage.t() | TextToImage.t(),
          opts :: keyword
        ) ::
          {:ok, Generate.v2_beta_stable_image_generate_sd3_post_200__resp() | String.t()}
          | {:error,
             ContentModerationResponse.t()
             | Generate.v2_beta_stable_image_generate_sd3_post_400_json_resp()
             | Generate.v2_beta_stable_image_generate_sd3_post_413_json_resp()
             | Generate.v2_beta_stable_image_generate_sd3_post_422_json_resp()
             | Generate.v2_beta_stable_image_generate_sd3_post_429_json_resp()
             | Generate.v2_beta_stable_image_generate_sd3_post_500_json_resp()}
