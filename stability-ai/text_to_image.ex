defmodule StabilityAI.TextToImage do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  ...
  @spec text_to_image(
          engine_id :: String.t(),
          body :: StabilityAI.TextToImageRequestBody.t(),
          opts :: keyword
        ) ::
          {:ok, StabilityAI.GenerationResponse.json_resp() | String.t()}
  ...
  def text_to_image(engine_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {StabilityAI.TextToImage, :text_to_image},
      url: "/v1/generation/#{engine_id}/text-to-image",
      body: body,
      method: :post,
      request: [{"application/json", {StabilityAI.TextToImageRequestBody, :t}}],
      response: [
        {200, {:union, [{StabilityAI.GenerationResponse, :json_resp}, string: :generic]}},
