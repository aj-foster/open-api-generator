defmodule Edit do
  ...
  def v2_beta_stable_image_edit_inpaint_post(body, opts \\ []) do
    ...
    client.request(%{
      ...
      response: [
        {200,
         {:union, [{Edit, :v2_beta_stable_image_edit_inpaint_post_200__resp}, string: "binary"]}},
  ...
  def v2_beta_stable_image_edit_outpaint_post(body, opts \\ []) do
    ...
    client.request(%{
      ...
      response: [
        {200,
         {:union, [{Edit, :v2_beta_stable_image_edit_outpaint_post_200__resp}, string: "binary"]}},
  ...
  def v2_beta_stable_image_edit_remove_background_post(body, opts \\ []) do
    ...
    client.request(%{
      ...
      response: [
        {200,
         {:union,
          [{Edit, :v2_beta_stable_image_edit_remove_background_post_200__resp}, string: "binary"]}},
  ...
  def v2_beta_stable_image_edit_search_and_replace_post(body, opts \\ []) do
    ...
    client.request(%{
      ...
      response: [
        {200,
         {:union,
          [{Edit, :v2_beta_stable_image_edit_search_and_replace_post_200__resp}, string: "binary"]}},
