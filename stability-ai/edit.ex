defmodule StabilityAI.Edit do
  ...
  **Content Types**: `multipart/form-data`
  ...
  @spec v2_beta_stable_image_edit_inpaint_post(body :: map, opts :: keyword) ::
          {:ok, StabilityAI.Edit.v2_beta_stable_image_edit_inpaint_post_200__resp() | String.t()}
          | {:error,
  ...
  **Content Types**: `multipart/form-data`
  ...
  @spec v2_beta_stable_image_edit_outpaint_post(body :: map, opts :: keyword) ::
          {:ok, StabilityAI.Edit.v2_beta_stable_image_edit_outpaint_post_200__resp() | String.t()}
          | {:error,
             StabilityAI.ContentModerationResponse.t()
