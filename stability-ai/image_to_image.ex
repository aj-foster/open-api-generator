defmodule ImageToImage do
  ...
  @spec image_to_image(
          engine_id :: String.t(),
          body :: ImageToImageRequestBody.t(),
          opts :: keyword
  ...
  def image_to_image(engine_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      response: [
        {200, {:union, [{GenerationResponse, :json_resp}, string: "binary"]}},
        {400, {Error, :t}},
        {401, {Error, :t}},
        {403, {Error, :t}},
        {404, {Error, :t}},
  ...
  > NOTE: Only **Version 1** engines will work with this endpoint.
  """
  @spec masking(engine_id :: String.t(), body :: MaskingRequestBody.t(), opts :: keyword) ::
          {:ok, GenerationResponse.json_resp() | String.t()} | {:error, Error.t()}
  ...
  @spec upscale_image(
          engine_id :: String.t(),
          body :: RealESRGANUpscaleRequestBody.t(),
          opts :: keyword
        ) :: {:ok, GenerationResponse.json_resp() | String.t()} | {:error, Error.t()}
