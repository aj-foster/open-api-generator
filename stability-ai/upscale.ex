defmodule Upscale do
  ...
  **Content Types**: `multipart/form-data`
  ...
  @spec v2_beta_stable_image_upscale_creative_post(body :: map, opts :: keyword) ::
          {:ok, Upscale.v2_beta_stable_image_upscale_creative_post_200_json_resp()}
          | {:error,
             ContentModerationResponse.t()
             | Upscale.v2_beta_stable_image_upscale_creative_post_400_json_resp()
             | Upscale.v2_beta_stable_image_upscale_creative_post_413_json_resp()
             | Upscale.v2_beta_stable_image_upscale_creative_post_422_json_resp()
             | Upscale.v2_beta_stable_image_upscale_creative_post_429_json_resp()
             | Upscale.v2_beta_stable_image_upscale_creative_post_500_json_resp()}
  ...
  @spec v2_beta_stable_image_upscale_creative_result_id_get(id :: String.t(), opts :: keyword) ::
          {:ok,
           ...
           | Upscale.v2_beta_stable_image_upscale_creative_result_id_get_202_json_resp()
           | String.t()}
          | {:error,
             Upscale.v2_beta_stable_image_upscale_creative_result_id_get_400_json_resp()
             | Upscale.v2_beta_stable_image_upscale_creative_result_id_get_404_json_resp()
             | Upscale.v2_beta_stable_image_upscale_creative_result_id_get_500_json_resp()}
