defmodule StabilityAI.Upscale do
  @moduledoc """
  ...
  **Content Types**: `multipart/form-data`
  """
  @spec v2_beta_stable_image_upscale_creative_post(body :: map, opts :: keyword) ::
          {:ok, StabilityAI.Upscale.v2_beta_stable_image_upscale_creative_post_200_json_resp()}
          | {:error,
             StabilityAI.ContentModerationResponse.t()
             | StabilityAI.Upscale.v2_beta_stable_image_upscale_creative_post_400_json_resp()
             | StabilityAI.Upscale.v2_beta_stable_image_upscale_creative_post_413_json_resp()
             | StabilityAI.Upscale.v2_beta_stable_image_upscale_creative_post_422_json_resp()
             | StabilityAI.Upscale.v2_beta_stable_image_upscale_creative_post_429_json_resp()
             | StabilityAI.Upscale.v2_beta_stable_image_upscale_creative_post_500_json_resp()}
  def v2_beta_stable_image_upscale_creative_post(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {StabilityAI.Upscale, :v2_beta_stable_image_upscale_creative_post},
      url: "/v2beta/stable-image/upscale/creative",
      body: body,
      method: :post,
      request: [{"multipart/form-data", :map}],
      response: [
        {200, {StabilityAI.Upscale, :v2_beta_stable_image_upscale_creative_post_200_json_resp}},
        {400, {StabilityAI.Upscale, :v2_beta_stable_image_upscale_creative_post_400_json_resp}},
        {403, {StabilityAI.ContentModerationResponse, :t}},
        {413, {StabilityAI.Upscale, :v2_beta_stable_image_upscale_creative_post_413_json_resp}},
        {422, {StabilityAI.Upscale, :v2_beta_stable_image_upscale_creative_post_422_json_resp}},
        {429, {StabilityAI.Upscale, :v2_beta_stable_image_upscale_creative_post_429_json_resp}},
        {500, {StabilityAI.Upscale, :v2_beta_stable_image_upscale_creative_post_500_json_resp}}
      ],
      opts: opts
    })
  end
  ...
  """
  @spec v2_beta_stable_image_upscale_creative_result_id_get(id :: String.t(), opts :: keyword) ::
          {:ok,
           binary
           | StabilityAI.Upscale.v2_beta_stable_image_upscale_creative_result_id_get_200__resp()
           | StabilityAI.Upscale.v2_beta_stable_image_upscale_creative_result_id_get_202_json_resp()}
          | {:error,
             StabilityAI.Upscale.v2_beta_stable_image_upscale_creative_result_id_get_400_json_resp()
             | StabilityAI.Upscale.v2_beta_stable_image_upscale_creative_result_id_get_404_json_resp()
             | StabilityAI.Upscale.v2_beta_stable_image_upscale_creative_result_id_get_500_json_resp()}
  def v2_beta_stable_image_upscale_creative_result_id_get(id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [id: id],
      call: {StabilityAI.Upscale, :v2_beta_stable_image_upscale_creative_result_id_get},
