defmodule ImageToVideo do
  ...
  @spec v2_beta_image_to_video_post(body :: map, opts :: keyword) ::
          {:ok, ImageToVideo.v2_beta_image_to_video_post_200_json_resp()}
          | {:error,
             ContentModerationResponse.t()
             | ImageToVideo.v2_beta_image_to_video_post_400_json_resp()
             | ImageToVideo.v2_beta_image_to_video_post_413_json_resp()
             | ImageToVideo.v2_beta_image_to_video_post_422_json_resp()
             | ImageToVideo.v2_beta_image_to_video_post_429_json_resp()
             | ImageToVideo.v2_beta_image_to_video_post_500_json_resp()}
  ...
  @spec v2_beta_image_to_video_result_id_get(id :: String.t(), opts :: keyword) ::
          {:ok,
           ImageToVideo.v2_beta_image_to_video_result_id_get_200__resp()
           | ImageToVideo.v2_beta_image_to_video_result_id_get_202_json_resp()
           | String.t()}
          | {:error,
             ImageToVideo.v2_beta_image_to_video_result_id_get_400_json_resp()
             | ImageToVideo.v2_beta_image_to_video_result_id_get_404_json_resp()
             | ImageToVideo.v2_beta_image_to_video_result_id_get_500_json_resp()}
