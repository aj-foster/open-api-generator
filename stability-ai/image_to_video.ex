defmodule StabilityAI.ImageToVideo do
  @moduledoc """
  ...
  **Content Types**: `multipart/form-data`
  """
  @spec v2_beta_image_to_video_post(body :: map, opts :: keyword) ::
          {:ok, StabilityAI.ImageToVideo.v2_beta_image_to_video_post_200_json_resp()}
          | {:error,
             StabilityAI.ContentModerationResponse.t()
             | StabilityAI.ImageToVideo.v2_beta_image_to_video_post_400_json_resp()
             | StabilityAI.ImageToVideo.v2_beta_image_to_video_post_413_json_resp()
             | StabilityAI.ImageToVideo.v2_beta_image_to_video_post_422_json_resp()
             | StabilityAI.ImageToVideo.v2_beta_image_to_video_post_429_json_resp()
             | StabilityAI.ImageToVideo.v2_beta_image_to_video_post_500_json_resp()}
  def v2_beta_image_to_video_post(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {StabilityAI.ImageToVideo, :v2_beta_image_to_video_post},
      url: "/v2beta/image-to-video",
      body: body,
      method: :post,
      request: [{"multipart/form-data", :map}],
      response: [
        {200, {StabilityAI.ImageToVideo, :v2_beta_image_to_video_post_200_json_resp}},
        {400, {StabilityAI.ImageToVideo, :v2_beta_image_to_video_post_400_json_resp}},
        {403, {StabilityAI.ContentModerationResponse, :t}},
        {413, {StabilityAI.ImageToVideo, :v2_beta_image_to_video_post_413_json_resp}},
        {422, {StabilityAI.ImageToVideo, :v2_beta_image_to_video_post_422_json_resp}},
        {429, {StabilityAI.ImageToVideo, :v2_beta_image_to_video_post_429_json_resp}},
        {500, {StabilityAI.ImageToVideo, :v2_beta_image_to_video_post_500_json_resp}}
      ],
      opts: opts
    })
  end
  ...
  """
  @spec v2_beta_image_to_video_result_id_get(id :: String.t(), opts :: keyword) ::
          {:ok,
           binary
           | StabilityAI.ImageToVideo.v2_beta_image_to_video_result_id_get_200__resp()
           | StabilityAI.ImageToVideo.v2_beta_image_to_video_result_id_get_202_json_resp()}
          | {:error,
             StabilityAI.ImageToVideo.v2_beta_image_to_video_result_id_get_400_json_resp()
             | StabilityAI.ImageToVideo.v2_beta_image_to_video_result_id_get_404_json_resp()
             | StabilityAI.ImageToVideo.v2_beta_image_to_video_result_id_get_500_json_resp()}
  def v2_beta_image_to_video_result_id_get(id, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [id: id],
      call: {StabilityAI.ImageToVideo, :v2_beta_image_to_video_result_id_get},
      ...
      response: [
        ...
        {202, {StabilityAI.ImageToVideo, :v2_beta_image_to_video_result_id_get_202_json_resp}},
        {400, {StabilityAI.ImageToVideo, :v2_beta_image_to_video_result_id_get_400_json_resp}},
        {404, {StabilityAI.ImageToVideo, :v2_beta_image_to_video_result_id_get_404_json_resp}},
        {500, {StabilityAI.ImageToVideo, :v2_beta_image_to_video_result_id_get_500_json_resp}}
      ],
      opts: opts
    })
  end
