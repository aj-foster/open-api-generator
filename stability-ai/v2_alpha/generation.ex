defmodule V2Alpha.Generation do
  ...
  """
  @spec v2_alpha_generation_image_to_video_post(body :: ImageToVideoRequest.t(), opts :: keyword) ::
          {:ok, V2Alpha.Generation.v2_alpha_generation_image_to_video_post_200_json_resp()}
          | {:error,
             V2Alpha.Generation.v2_alpha_generation_image_to_video_post_400_json_resp()
             | V2Alpha.Generation.v2_alpha_generation_image_to_video_post_500_json_resp()}
  ...
  **How to use:** set the `mode` parameter to `mask` and either pass in an `image` with an alpha channel 
  ...
  @spec v2_alpha_generation_stable_image_inpaint_post(
          body :: InpaintingMaskingModeRequestBody.t() | InpaintingSearchModeRequestBody.t(),
          opts :: keyword
        ) ::
          {:ok,
          ...
          | {:error,
             ...
             | V2Alpha.Generation.v2_alpha_generation_stable_image_inpaint_post_400_json_resp()
             | V2Alpha.Generation.v2_alpha_generation_stable_image_inpaint_post_500_json_resp()}
  ...
  @spec v2_alpha_generation_stable_image_upscale_post(body :: map, opts :: keyword) ::
          {:ok, V2Alpha.Generation.v2_alpha_generation_stable_image_upscale_post_200_json_resp()}
          | {:error,
             ContentModerationResponse.t()
             | V2Alpha.Generation.v2_alpha_generation_stable_image_upscale_post_400_json_resp()
             | V2Alpha.Generation.v2_alpha_generation_stable_image_upscale_post_500_json_resp()}
  ...
  @spec v2_alpha_generation_stable_image_upscale_result_id_get(id :: String.t(), opts :: keyword) ::
          {:ok,
           V2Alpha.Generation.v2_alpha_generation_stable_image_upscale_result_id_get_200__resp()
           | V2Alpha.Generation.v2_alpha_generation_stable_image_upscale_result_id_get_202_json_resp()
           | String.t()}
          | {:error,
             ContentModerationResponse.t()
             | V2Alpha.Generation.v2_alpha_generation_stable_image_upscale_result_id_get_400_json_resp()
             | V2Alpha.Generation.v2_alpha_generation_stable_image_upscale_result_id_get_404_json_resp()
             | V2Alpha.Generation.v2_alpha_generation_stable_image_upscale_result_id_get_500_json_resp()}
