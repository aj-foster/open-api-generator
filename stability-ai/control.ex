defmodule StabilityAI.Control do
  @moduledoc """
  ...
  **Content Types**: `multipart/form-data`
  """
  @spec v2_beta_stable_image_control_sketch_post(body :: map, opts :: keyword) ::
          {:ok, binary | StabilityAI.Control.v2_beta_stable_image_control_sketch_post_200__resp()}
          | {:error,
             StabilityAI.ContentModerationResponse.t()
             | StabilityAI.Control.v2_beta_stable_image_control_sketch_post_400_json_resp()
             | StabilityAI.Control.v2_beta_stable_image_control_sketch_post_413_json_resp()
             | StabilityAI.Control.v2_beta_stable_image_control_sketch_post_422_json_resp()
             | StabilityAI.Control.v2_beta_stable_image_control_sketch_post_429_json_resp()
             | StabilityAI.Control.v2_beta_stable_image_control_sketch_post_500_json_resp()}
  def v2_beta_stable_image_control_sketch_post(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {StabilityAI.Control, :v2_beta_stable_image_control_sketch_post},
      ...
      response: [
        {200,
         {:union,
          [
            {StabilityAI.Control, :v2_beta_stable_image_control_sketch_post_200__resp},
            string: "binary"
          ]}},
        {400, {StabilityAI.Control, :v2_beta_stable_image_control_sketch_post_400_json_resp}},
        {403, {StabilityAI.ContentModerationResponse, :t}},
        {413, {StabilityAI.Control, :v2_beta_stable_image_control_sketch_post_413_json_resp}},
        {422, {StabilityAI.Control, :v2_beta_stable_image_control_sketch_post_422_json_resp}},
        {429, {StabilityAI.Control, :v2_beta_stable_image_control_sketch_post_429_json_resp}},
        {500, {StabilityAI.Control, :v2_beta_stable_image_control_sketch_post_500_json_resp}}
      ],
      opts: opts
    })
  end
  ...
  **Content Types**: `multipart/form-data`
  """
  @spec v2_beta_stable_image_control_structure_post(body :: map, opts :: keyword) ::
          {:ok,
           binary | StabilityAI.Control.v2_beta_stable_image_control_structure_post_200__resp()}
          | {:error,
             StabilityAI.ContentModerationResponse.t()
             | StabilityAI.Control.v2_beta_stable_image_control_structure_post_400_json_resp()
             | StabilityAI.Control.v2_beta_stable_image_control_structure_post_413_json_resp()
             | StabilityAI.Control.v2_beta_stable_image_control_structure_post_422_json_resp()
             | StabilityAI.Control.v2_beta_stable_image_control_structure_post_429_json_resp()
             | StabilityAI.Control.v2_beta_stable_image_control_structure_post_500_json_resp()}
  def v2_beta_stable_image_control_structure_post(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {StabilityAI.Control, :v2_beta_stable_image_control_structure_post},
      ...
      response: [
        {200,
         {:union,
          [
            {StabilityAI.Control, :v2_beta_stable_image_control_structure_post_200__resp},
            string: "binary"
          ]}},
        {400, {StabilityAI.Control, :v2_beta_stable_image_control_structure_post_400_json_resp}},
        {403, {StabilityAI.ContentModerationResponse, :t}},
        {413, {StabilityAI.Control, :v2_beta_stable_image_control_structure_post_413_json_resp}},
        {422, {StabilityAI.Control, :v2_beta_stable_image_control_structure_post_422_json_resp}},
        {429, {StabilityAI.Control, :v2_beta_stable_image_control_structure_post_429_json_resp}},
        {500, {StabilityAI.Control, :v2_beta_stable_image_control_structure_post_500_json_resp}}
      ],
      opts: opts
    })
  end
