defmodule Control do
  ...
  **Content Types**: `multipart/form-data`
  ...
  @spec v2_beta_stable_image_control_sketch_post(body :: map, opts :: keyword) ::
          {:ok, Control.v2_beta_stable_image_control_sketch_post_200__resp() | String.t()}
          | {:error,
             ContentModerationResponse.t()
             | Control.v2_beta_stable_image_control_sketch_post_400_json_resp()
             | Control.v2_beta_stable_image_control_sketch_post_413_json_resp()
             | Control.v2_beta_stable_image_control_sketch_post_422_json_resp()
             | Control.v2_beta_stable_image_control_sketch_post_429_json_resp()
             | Control.v2_beta_stable_image_control_sketch_post_500_json_resp()}
  ...
  **Content Types**: `multipart/form-data`
  ...
  @spec v2_beta_stable_image_control_structure_post(body :: map, opts :: keyword) ::
          {:ok, Control.v2_beta_stable_image_control_structure_post_200__resp() | String.t()}
          | {:error,
             ContentModerationResponse.t()
             | Control.v2_beta_stable_image_control_structure_post_400_json_resp()
             | Control.v2_beta_stable_image_control_structure_post_413_json_resp()
             | Control.v2_beta_stable_image_control_structure_post_422_json_resp()
             | Control.v2_beta_stable_image_control_structure_post_429_json_resp()
             | Control.v2_beta_stable_image_control_structure_post_500_json_resp()}
