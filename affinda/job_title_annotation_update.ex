defmodule Affinda.JobTitleAnnotationUpdate do
  @moduledoc """
  Provides struct and type for a JobTitleAnnotationUpdate
  """
  ...
  @type t :: %__MODULE__{
          ...
          parsed: Affinda.JobTitleAnnotationUpdateParsed.t() | nil,
          raw: String.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      isVerified: :boolean,
      pageIndex: :integer,
      parsed: {Affinda.JobTitleAnnotationUpdateParsed, :t},
      raw: :string,
