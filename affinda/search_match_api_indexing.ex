defmodule SearchMatchAPIIndexing do
  ...
  """
  @spec create_index(body :: IndexCreate.t(), opts :: keyword) ::
  ...
  @spec create_index_document(name :: String.t(), body :: map, opts :: keyword) ::
          {:ok, SearchMatchAPIIndexing.create_index_document_201_json_resp()}
  ...
  """
  @spec delete_index(name :: String.t(), opts :: keyword) :: :ok | {:error, RequestError.t()}
  ...
  @type get_all_index_documents_200_json_resp :: %{
          ...
          results: [SearchMatchAPIIndexing.get_all_index_documents_200_json_resp_results()] | nil
        }
  ...
  @spec get_all_index_documents(name :: String.t(), opts :: keyword) ::
          {:ok, SearchMatchAPIIndexing.get_all_index_documents_200_json_resp()}
          | {:error, RequestError.t()}
  ...
  @spec get_all_indexes(opts :: keyword) ::
          {:ok, SearchMatchAPIIndexing.get_all_indexes_200_json_resp()}
          | {:error, RequestError.t()}
  ...
  """
  @spec update_index(name :: String.t(), body :: IndexUpdate.t(), opts :: keyword) ::
          {:ok, Index.t()} | {:error, RequestError.t()}
  ...
  def __fields__(:get_all_index_documents_200_json_resp) do
    [
      ...
      results: [{SearchMatchAPIIndexing, :get_all_index_documents_200_json_resp_results}]
    ]
  end
