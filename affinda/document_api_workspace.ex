defmodule DocumentAPIWorkspace do
  ...
  Create a workspace
  """
  @spec create_workspace(body :: WorkspaceCreate.t(), opts :: keyword) ::
  ...
  Create a workspace membership.
  """
  @spec create_workspace_membership(body :: WorkspaceMembershipCreate.t(), opts :: keyword) ::
  ...
  """
  @spec get_all_workspace_memberships(opts :: keyword) :: {:ok, map} | {:error, RequestError.t()}
  ...
  """
  @spec get_all_workspaces(opts :: keyword) :: {:ok, [Workspace.t()]} | {:error, RequestError.t()}
  ...
  Update a workspace.
  """
  @spec update_workspace(identifier :: String.t(), body :: WorkspaceUpdate.t(), opts :: keyword) ::
          {:ok, Workspace.t()} | {:error, RequestError.t()}
