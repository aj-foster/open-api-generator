defmodule Affinda.YearsExperienceAnnotationUpdate do
  @moduledoc """
  Provides struct and type for a YearsExperienceAnnotationUpdate
  """
  ...
  @type t :: %__MODULE__{
          ...
          parsed: Affinda.YearsExperienceAnnotationUpdateParsed.t() | nil,
          raw: String.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      isVerified: :boolean,
      pageIndex: :integer,
      parsed: {Affinda.YearsExperienceAnnotationUpdateParsed, :t},
      raw: :string,
