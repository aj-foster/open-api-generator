defmodule ExpectedRemunerationAnnotationUpdate do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          parsed: ExpectedRemunerationAnnotationUpdateParsed.t() | nil,
          raw: String.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      isVerified: :boolean,
      pageIndex: :integer,
      parsed: {ExpectedRemunerationAnnotationUpdateParsed, :t},
      raw: {:string, :generic},
