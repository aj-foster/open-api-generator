defmodule Affinda.ExpectedRemunerationAnnotationUpdate do
  @moduledoc """
  Provides struct and type for a ExpectedRemunerationAnnotationUpdate
  """
  ...
  @type t :: %__MODULE__{
          ...
          parsed: Affinda.ExpectedRemunerationAnnotationUpdateParsed.t() | nil,
          raw: String.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      isVerified: :boolean,
      pageIndex: :integer,
      parsed: {Affinda.ExpectedRemunerationAnnotationUpdateParsed, :t},
      raw: :string,
