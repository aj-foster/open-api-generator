defmodule DocumentAPIExtractor do
  ...
  **Content Types**: `application/json`
  """
  @spec create_extractor(body :: ExtractorCreate.t(), opts :: keyword) ::
  ...
  """
  @spec get_all_extractors(opts :: keyword) :: {:ok, [Extractor.t()]} | {:error, RequestError.t()}
  ...
  **Content Types**: `application/json`
  ...
  """
  @spec update_extractor(identifier :: String.t(), body :: ExtractorUpdate.t(), opts :: keyword) ::
          {:ok, Extractor.t()} | {:error, RequestError.t()}
