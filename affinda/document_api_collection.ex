defmodule DocumentAPICollection do
  ...
  Create a collection
  """
  @spec create_collection(body :: CollectionCreate.t(), opts :: keyword) ::
  ...
  """
  @spec update_collection(identifier :: String.t(), body :: CollectionUpdate.t(), opts :: keyword) ::
          {:ok, Collection.t()} | {:error, RequestError.t()}
