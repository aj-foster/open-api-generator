defmodule Affinda.OrganizationValidationToolConfig do
  @moduledoc """
  Provides struct and type for a OrganizationValidationToolConfig
  """
  ...
  @type t :: %__MODULE__{
          ...
          theme: Affinda.ThemeConfig.t() | nil
        }
