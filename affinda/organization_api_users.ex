defmodule OrganizationAPIUsers do
  ...
  Create an API user
  """
  @spec create_api_user(body :: ApiUserCreate.t(), opts :: keyword) ::
  ...
  """
  @spec delete_api_user(id :: integer, opts :: keyword) :: :ok | {:error, RequestError.t()}
  ...
  """
  @spec get_all_api_users(opts :: keyword) :: {:ok, map} | {:error, RequestError.t()}
  ...
  """
  @spec update_api_user(id :: integer, body :: ApiUserUpdate.t(), opts :: keyword) ::
          {:ok, ApiUserWithoutKey.t()} | {:error, RequestError.t()}
