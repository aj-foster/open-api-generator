defmodule Affinda.JobTitleAnnotation do
  @moduledoc """
  Provides struct and type for a JobTitleAnnotation
  """
  ...
  @type t :: %__MODULE__{
          ...
          parent: integer | nil,
          parsed: Affinda.JobTitleAnnotationParsed.t() | nil,
          raw: String.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      pageIndex: :integer,
      parent: :integer,
      parsed: {Affinda.JobTitleAnnotationParsed, :t},
      raw: :string,
