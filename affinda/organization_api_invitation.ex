defmodule OrganizationAPIInvitation do
  ...
  Create a new invitation.
  """
  @spec create_invitation(body :: InvitationCreate.t(), opts :: keyword) ::
  ...
  """
  @spec get_all_invitations(opts :: keyword) :: {:ok, map} | {:error, RequestError.t()}
  ...
  """
  @spec update_invitation(identifier :: String.t(), body :: InvitationUpdate.t(), opts :: keyword) ::
          {:ok, Invitation.t()} | {:error, RequestError.t()}
