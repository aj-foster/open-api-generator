defmodule WebhookAPI do
  ...
  """
  @spec create_resthook_subscription(body :: ResthookSubscriptionCreate.t(), opts :: keyword) ::
          {:ok, ResthookSubscription.t()} | {:error, RequestError.t()}
  ...
  """
  @spec get_all_resthook_subscriptions(opts :: keyword) :: {:ok, map} | {:error, RequestError.t()}
  ...
  @spec update_resthook_subscription(
          id :: integer,
          body :: ResthookSubscriptionUpdate.t(),
          opts :: keyword
        ) :: {:ok, ResthookSubscription.t()} | {:error, RequestError.t()}
