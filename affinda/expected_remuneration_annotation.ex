defmodule Affinda.ExpectedRemunerationAnnotation do
  @moduledoc """
  Provides struct and type for a ExpectedRemunerationAnnotation
  """
  ...
  @type t :: %__MODULE__{
          ...
          parent: integer | nil,
          parsed: Affinda.ExpectedRemunerationAnnotationParsed.t() | nil,
          raw: String.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      pageIndex: :integer,
      parent: :integer,
      parsed: {Affinda.ExpectedRemunerationAnnotationParsed, :t},
      raw: :string,
