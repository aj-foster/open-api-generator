defmodule DocumentAPIMappingDataSources do
  ...
  """
  @spec create_mapping(body :: MappingCreate.t(), opts :: keyword) ::
  ...
  """
  @spec create_mapping_data_source(body :: MappingDataSourceCreate.t(), opts :: keyword) ::
  ...
  @spec list_mapping_data_source_values(identifier :: String.t(), opts :: keyword) ::
          {:ok, DocumentAPIMappingDataSources.list_mapping_data_source_values_200_json_resp()}
  ...
  @spec list_mapping_data_sources(opts :: keyword) ::
          {:ok, DocumentAPIMappingDataSources.list_mapping_data_sources_200_json_resp()}
          | {:error, RequestError.t()}
  ...
  @spec list_mappings(opts :: keyword) ::
          {:ok, DocumentAPIMappingDataSources.list_mappings_200_json_resp()}
          | {:error, RequestError.t()}
  ...
  """
  @spec update_mapping(identifier :: String.t(), body :: MappingUpdate.t(), opts :: keyword) ::
          {:ok, Mapping.t()} | {:error, RequestError.t()}
