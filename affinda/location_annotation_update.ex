defmodule Affinda.LocationAnnotationUpdate do
  @moduledoc """
  Provides struct and type for a LocationAnnotationUpdate
  """
  ...
  @type t :: %__MODULE__{
          ...
          parsed: Affinda.LocationAnnotationUpdateParsed.t() | nil,
          raw: String.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      isVerified: :boolean,
      pageIndex: :integer,
      parsed: {Affinda.LocationAnnotationUpdateParsed, :t},
      raw: :string,
