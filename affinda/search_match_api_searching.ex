defmodule Affinda.SearchMatchAPISearching do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  ...
  Search parameters
  """
  @spec create_job_description_search(
          body :: Affinda.JobDescriptionSearchParameters.t(),
          opts :: keyword
        ) :: {:ok, Affinda.JobDescriptionSearch.t()} | {:error, Affinda.RequestError.t()}
  def create_job_description_search(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Affinda.SearchMatchAPISearching, :create_job_description_search},
      url: "/v3/job_description_search",
      body: body,
      method: :post,
      query: query,
      request: [{"application/json", {Affinda.JobDescriptionSearchParameters, :t}}],
      response: [
        {201, {Affinda.JobDescriptionSearch, :t}},
  ...
  **Content Types**: `application/json`
  ...
  Search parameters
  """
  @spec create_resume_search(body :: Affinda.ResumeSearchParameters.t(), opts :: keyword) ::
          {:ok, Affinda.ResumeSearch.t()} | {:error, Affinda.RequestError.t()}
  def create_resume_search(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Affinda.SearchMatchAPISearching, :create_resume_search},
      url: "/v3/resume_search",
      body: body,
      method: :post,
      query: query,
      request: [{"application/json", {Affinda.ResumeSearchParameters, :t}}],
      response: [
        {201, {Affinda.ResumeSearch, :t}},
        {400, {Affinda.RequestError, :t}},
        {401, {Affinda.RequestError, :t}},
        default: {Affinda.RequestError, :t}
      ],
  ...
  **Content Types**: `application/json`
  ...
  Search parameters
  """
  @spec get_job_description_search_detail(
          identifier :: String.t(),
          body :: Affinda.JobDescriptionSearchParameters.t(),
          opts :: keyword
        ) :: {:ok, Affinda.JobDescriptionSearchDetail.t()} | {:error, Affinda.RequestError.t()}
  def get_job_description_search_detail(identifier, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [identifier: identifier, body: body],
      call: {Affinda.SearchMatchAPISearching, :get_job_description_search_detail},
      url: "/v3/job_description_search/details/#{identifier}",
      body: body,
      method: :post,
      request: [{"application/json", {Affinda.JobDescriptionSearchParameters, :t}}],
      response: [
        {200, {Affinda.JobDescriptionSearchDetail, :t}},
        {400, {Affinda.RequestError, :t}},
        {401, {Affinda.RequestError, :t}},
        default: {Affinda.RequestError, :t}
      ],
  ...
  **Content Types**: `application/json`
  ...
  Search parameters
  """
  @spec get_resume_search_detail(
          identifier :: String.t(),
          body :: Affinda.ResumeSearchParameters.t(),
          opts :: keyword
        ) :: {:ok, Affinda.ResumeSearchDetail.t()} | {:error, Affinda.RequestError.t()}
  def get_resume_search_detail(identifier, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [identifier: identifier, body: body],
      call: {Affinda.SearchMatchAPISearching, :get_resume_search_detail},
      url: "/v3/resume_search/details/#{identifier}",
      body: body,
      method: :post,
      request: [{"application/json", {Affinda.ResumeSearchParameters, :t}}],
      response: [
        {200, {Affinda.ResumeSearchDetail, :t}},
        {400, {Affinda.RequestError, :t}},
        {401, {Affinda.RequestError, :t}},
        default: {Affinda.RequestError, :t}
      ],
  ...
  """
  @spec get_resume_search_match(opts :: keyword) ::
          {:ok, Affinda.ResumeSearchMatch.t()} | {:error, Affinda.RequestError.t()}
  def get_resume_search_match(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Affinda.SearchMatchAPISearching, :get_resume_search_match},
      url: "/v3/resume_search/match",
      method: :get,
      query: query,
      response: [
        {200, {Affinda.ResumeSearchMatch, :t}},
        {400, {Affinda.RequestError, :t}},
        {401, {Affinda.RequestError, :t}},
        default: {Affinda.RequestError, :t}
      ],
  ...
  """
  @spec get_resume_search_suggestion_job_title(opts :: keyword) ::
          {:ok, [String.t()]} | {:error, Affinda.RequestError.t()}
  def get_resume_search_suggestion_job_title(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Affinda.SearchMatchAPISearching, :get_resume_search_suggestion_job_title},
  ...
  """
  @spec get_resume_search_suggestion_skill(opts :: keyword) ::
          {:ok, [String.t()]} | {:error, Affinda.RequestError.t()}
  def get_resume_search_suggestion_skill(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Affinda.SearchMatchAPISearching, :get_resume_search_suggestion_skill},
  ...
  """
  @spec list_occupation_groups(opts :: keyword) ::
          {:ok, [Affinda.OccupationGroup.t()]} | {:error, Affinda.RequestError.t()}
  def list_occupation_groups(opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [],
      call: {Affinda.SearchMatchAPISearching, :list_occupation_groups},
      url: "/v3/occupation_groups",
      method: :get,
      response: [
        {200, [{Affinda.OccupationGroup, :t}]},
        {400, {Affinda.RequestError, :t}},
        {401, {Affinda.RequestError, :t}},
        default: {Affinda.RequestError, :t}
      ],
