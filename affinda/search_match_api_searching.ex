defmodule SearchMatchAPISearching do
  ...
  **Content Types**: `application/json`
  ...
  Search parameters
  """
  @spec create_job_description_search(body :: JobDescriptionSearchParameters.t(), opts :: keyword) ::
  ...
  **Content Types**: `application/json`
  ...
  Search parameters
  """
  @spec create_resume_search(body :: ResumeSearchParameters.t(), opts :: keyword) ::
  ...
  **Content Types**: `application/json`
  ...
  @spec get_job_description_search_detail(
          identifier :: String.t(),
          body :: JobDescriptionSearchParameters.t(),
          opts :: keyword
