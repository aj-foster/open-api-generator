defmodule Affinda.YearsExperienceAnnotation do
  @moduledoc """
  Provides struct and type for a YearsExperienceAnnotation
  """
  ...
  @type t :: %__MODULE__{
          ...
          parent: integer | nil,
          parsed: Affinda.YearsExperienceAnnotationParsed.t() | nil,
          raw: String.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      pageIndex: :integer,
      parent: :integer,
      parsed: {Affinda.YearsExperienceAnnotationParsed, :t},
      raw: :string,
