defmodule DocumentAPIDataPoint do
  ...
  """
  @spec create_data_point(body :: DataPointCreate.t(), opts :: keyword) ::
  ...
  """
  @spec create_data_point_choice(body :: DataPointChoiceCreate.t(), opts :: keyword) ::
  ...
  """
  @spec get_data_point_choices(opts :: keyword) :: {:ok, map} | {:error, RequestError.t()}
  ...
  """
  @spec replace_data_point_choices(body :: DataPointChoiceReplaceRequest.t(), opts :: keyword) ::
  ...
  """
  @spec update_data_point(identifier :: String.t(), body :: DataPointUpdate.t(), opts :: keyword) ::
          {:ok, DataPoint.t()} | {:error, RequestError.t()}
