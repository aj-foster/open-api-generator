defmodule Affinda.DocumentAPIDocument do
  @moduledoc """
  ...
  **Content Types**: `multipart/form-data`
  ...
  """
  @spec create_document(body :: Affinda.DocumentCreate.t(), opts :: keyword) ::
          {:ok, Affinda.Document.t()} | {:error, Affinda.RequestError.t()}
  def create_document(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Affinda.DocumentAPIDocument, :create_document},
      url: "/v3/documents",
      body: body,
      method: :post,
      request: [{"multipart/form-data", {Affinda.DocumentCreate, :t}}],
      response: [
        {200, {Affinda.Document, :t}},
        {201, {Affinda.Document, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec create_validation_result(body :: Affinda.ValidationResultCreate.t(), opts :: keyword) ::
          {:ok, Affinda.ValidationResult.t()} | {:error, Affinda.RequestError.t()}
  def create_validation_result(body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [body: body],
      call: {Affinda.DocumentAPIDocument, :create_validation_result},
      url: "/v3/validation_results",
      body: body,
      method: :post,
      request: [{"application/json", {Affinda.ValidationResultCreate, :t}}],
      response: [
        {201, {Affinda.ValidationResult, :t}},
        {400, {Affinda.RequestError, :t}},
        {401, {Affinda.RequestError, :t}},
        default: {Affinda.RequestError, :t}
      ],
  ...
  """
  @spec delete_document(identifier :: String.t(), opts :: keyword) ::
  ...
  def delete_document(identifier, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Affinda.DocumentAPIDocument, :delete_document},
  ...
  """
  @spec delete_validation_result(id :: integer, opts :: keyword) ::
          :ok | {:error, Affinda.RequestError.t()}
  def delete_validation_result(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Affinda.DocumentAPIDocument, :delete_validation_result},
  ...
  **Content Types**: `application/json`
  ...
  """
  @spec edit_document_pages(
          identifier :: String.t(),
          body :: Affinda.DocumentEditRequest.t(),
          opts :: keyword
        ) :: {:ok, [Affinda.Meta.t()]} | {:error, Affinda.RequestError.t()}
  def edit_document_pages(identifier, body, opts \\ []) do
    client = opts[:client] || @default_client

    client.request(%{
      args: [identifier: identifier, body: body],
      call: {Affinda.DocumentAPIDocument, :edit_document_pages},
      url: "/v3/validate/#{identifier}/split",
      body: body,
      method: :post,
      request: [{"application/json", {Affinda.DocumentEditRequest, :t}}],
      response: [
        {200, [{Affinda.Meta, :t}]},
        {400, {Affinda.RequestError, :t}},
        {401, {Affinda.RequestError, :t}},
  ...
  """
  @spec get_all_documents(opts :: keyword) ::
          {:ok, Affinda.DocumentAPIDocument.get_all_documents_200_json_resp()}
  ...
  def get_all_documents(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Affinda.DocumentAPIDocument, :get_all_documents},
      url: "/v3/documents",
      method: :get,
      query: query,
      response: [
        {200, {Affinda.DocumentAPIDocument, :get_all_documents_200_json_resp}},
        {400, {Affinda.RequestError, :t}},
        {401, {Affinda.RequestError, :t}},
        default: {Affinda.RequestError, :t}
      ],
  ...
  """
  @spec get_all_validation_results(opts :: keyword) ::
          {:ok, [Affinda.ValidationResult.t()]} | {:error, Affinda.RequestError.t()}
  def get_all_validation_results(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Affinda.DocumentAPIDocument, :get_all_validation_results},
      url: "/v3/validation_results",
      method: :get,
      query: query,
      response: [
        {200, [{Affinda.ValidationResult, :t}]},
        {400, {Affinda.RequestError, :t}},
        {401, {Affinda.RequestError, :t}},
        default: {Affinda.RequestError, :t}
      ],
  ...
  """
  @spec get_document(identifier :: String.t(), opts :: keyword) ::
          {:ok, Affinda.Document.t()} | {:error, Affinda.RequestError.t()}
  def get_document(identifier, opts \\ []) do
    ...
    client.request(%{
      args: [identifier: identifier],
      call: {Affinda.DocumentAPIDocument, :get_document},
      url: "/v3/documents/#{identifier}",
      method: :get,
      query: query,
      response: [
  ...
  """
  @spec get_validation_result(id :: integer, opts :: keyword) ::
          {:ok, Affinda.ValidationResult.t()} | {:error, Affinda.RequestError.t()}
  def get_validation_result(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Affinda.DocumentAPIDocument, :get_validation_result},
      url: "/v3/validation_results/#{id}",
      method: :get,
      response: [
        {200, {Affinda.ValidationResult, :t}},
  ...
  **Content Types**: `application/json`
  ...
  def update_document(identifier, body, opts \\ []) do
    ...
    client.request(%{
      args: [identifier: identifier, body: body],
      call: {Affinda.DocumentAPIDocument, :update_document},
      url: "/v3/documents/#{identifier}",
      body: body,
      method: :patch,
      request: [{"application/json", {Affinda.DocumentUpdate, :t}}],
      response: [
        {200, {Affinda.Document, :t}},
        {400, {Affinda.RequestError, :t}},
        {401, {Affinda.RequestError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  """
  @spec update_document_data(
          identifier :: String.t(),
          body :: Affinda.JobDescriptionDataUpdate.t() | Affinda.ResumeData.t(),
          opts :: keyword
        ) :: {:ok, Affinda.Document.t()} | {:error, Affinda.RequestError.t()}
  def update_document_data(identifier, body, opts \\ []) do
    ...
    client.request(%{
      args: [identifier: identifier, body: body],
      call: {Affinda.DocumentAPIDocument, :update_document_data},
      url: "/v3/documents/#{identifier}/update_data",
      body: body,
      method: :post,
      request: [
        {"application/json",
         {:union, [{Affinda.JobDescriptionDataUpdate, :t}, {Affinda.ResumeData, :t}]}}
      ],
      response: [
        {200, {Affinda.Document, :t}},
        {400, {Affinda.RequestError, :t}},
  ...
  **Content Types**: `application/json`
  ...
  """
  @spec update_validation_result(
          id :: integer,
          body :: Affinda.ValidationResultUpdate.t(),
          opts :: keyword
        ) :: {:ok, Affinda.ValidationResult.t()} | {:error, Affinda.RequestError.t()}
  def update_validation_result(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Affinda.DocumentAPIDocument, :update_validation_result},
      url: "/v3/validation_results/#{id}",
      body: body,
      method: :patch,
      request: [{"application/json", {Affinda.ValidationResultUpdate, :t}}],
      response: [
        {200, {Affinda.ValidationResult, :t}},
        {400, {Affinda.RequestError, :t}},
        {401, {Affinda.RequestError, :t}},
  ...
  def __fields__(:get_all_documents_200_json_resp) do
    [count: :integer, next: :string, previous: :string, results: [{Affinda.Document, :t}]]
  end
end
