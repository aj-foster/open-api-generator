defmodule DocumentAPIDocument do
  ...
  **Content Types**: `multipart/form-data`
  ...
  """
  @spec create_document(body :: DocumentCreate.t(), opts :: keyword) ::
  ...
  **Content Types**: `application/json`
  """
  @spec create_validation_result(body :: ValidationResultCreate.t(), opts :: keyword) ::
  ...
  **Content Types**: `application/json`
  ...
  @spec get_all_documents(opts :: keyword) ::
          {:ok, DocumentAPIDocument.get_all_documents_200_json_resp()}
  ...
  **Content Types**: `application/json`
  ...
  """
  @spec update_document(identifier :: String.t(), body :: DocumentUpdate.t(), opts :: keyword) ::
          {:ok, Document.t()} | {:error, RequestError.t()}
  ...
  **Content Types**: `application/json`
  ...
  @spec update_document_data(
          identifier :: String.t(),
          body :: JobDescriptionDataUpdate.t() | ResumeData.t(),
          opts :: keyword
        ) :: {:ok, Document.t()} | {:error, RequestError.t()}
