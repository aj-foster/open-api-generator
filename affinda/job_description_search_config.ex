defmodule Affinda.JobDescriptionSearchConfig do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          searchToolTheme: Affinda.JobDescriptionSearchConfigSearchToolTheme.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      indices: [:string],
      maxResults: :integer,
      searchToolTheme: {Affinda.JobDescriptionSearchConfigSearchToolTheme, :t},
