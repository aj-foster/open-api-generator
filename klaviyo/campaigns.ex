defmodule Campaigns do
  ...
  **Scopes:**
  `campaigns:write`
  """
  @spec create_campaign(body :: CampaignCreateQuery.t(), opts :: keyword) ::
  ...
  **Scopes:**
  `campaigns:write`
  """
  @spec create_campaign_clone(body :: CampaignCloneQuery.t(), opts :: keyword) ::
          {:ok, PostCampaignResponse.t()}
          | {:error, ClientError.json_resp() | ServerError.json_resp()}
  ...
  **Scopes:**
  ...
  @spec create_campaign_message_assign_template(
          body :: CampaignMessageAssignTemplateQuery.t(),
          opts :: keyword
        ) ::
  ...
  **Scopes:**
  ...
  @spec create_campaign_recipient_estimation_job(
          body :: CampaignRecipientEstimationJobCreateQuery.t(),
          opts :: keyword
        ) ::
  ...
  **Scopes:**
  `campaigns:write`
  """
  @spec create_campaign_send_job(body :: CampaignSendJobCreateQuery.t(), opts :: keyword) ::
  ...
  **Scopes:**
  `campaigns:write`
  """
  @spec update_campaign(id :: String.t(), body :: CampaignPartialUpdateQuery.t(), opts :: keyword) ::
  ...
  **Scopes:**
  ...
  @spec update_campaign_message(
          id :: String.t(),
          body :: CampaignMessagePartialUpdateQuery.t(),
          opts :: keyword
        ) ::
  ...
  **Scopes:**
  ...
  @spec update_campaign_send_job(
          id :: String.t(),
          body :: CampaignSendJobPartialUpdateQuery.t(),
          opts :: keyword
        ) :: :ok | {:error, ClientError.json_resp() | ServerError.json_resp()}
