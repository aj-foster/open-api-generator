defmodule PostCampaignResponseDataRelationships do
  ...
  @type t :: %__MODULE__{
          "campaign-messages": PostCampaignResponseDataRelationshipsCampaignMessages.t() | nil,
  ...
  def __fields__(:t) do
    [
      "campaign-messages": {PostCampaignResponseDataRelationshipsCampaignMessages, :t},
