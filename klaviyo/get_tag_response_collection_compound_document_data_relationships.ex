defmodule GetTagResponseCollectionCompoundDocumentDataRelationships do
  ...
  @type t :: %__MODULE__{
          ...
          "tag-group": GetTagResponseCollectionCompoundDocumentDataRelationshipsTagGroup.t() | nil
        }
  ...
  def __fields__(:t) do
    [
      ...
      "tag-group": {GetTagResponseCollectionCompoundDocumentDataRelationshipsTagGroup, :t}
    ]
  end
end
