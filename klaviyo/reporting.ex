defmodule Reporting do
  ...
  **Content Types**: `application/json`
  """
  @spec query_campaign_values(body :: CampaignValuesRequestDTO.t(), opts :: keyword) ::
  ...
  **Content Types**: `application/json`
  """
  @spec query_flow_series(body :: FlowSeriesRequestDTO.t(), opts :: keyword) ::
  ...
  **Content Types**: `application/json`
  """
  @spec query_flow_values(body :: FlowValuesRequestDTO.t(), opts :: keyword) ::
