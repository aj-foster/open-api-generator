defmodule Klaviyo.Metrics do
  ...
  **Scopes:**
  ...
  """
  @spec get_metric(id :: String.t(), opts :: keyword) ::
  ...
  def get_metric(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Klaviyo.Metrics, :get_metric},
      url: "/api/metrics/#{id}/",
      method: :get,
      query: query,
      response: [
  ...
  **Scopes:**
  ...
  @spec get_metrics(opts :: keyword) ::
          {:ok, Klaviyo.GetMetricResponseCollection.t()}
          | {:error, Klaviyo.ClientError.json_resp() | Klaviyo.ServerError.json_resp()}
  def get_metrics(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Klaviyo.Metrics, :get_metrics},
      url: "/api/metrics/",
      method: :get,
      query: query,
      response: [
        {200, {Klaviyo.GetMetricResponseCollection, :t}},
        {"4XX", {Klaviyo.ClientError, :json_resp}},
        {"5XX", {Klaviyo.ServerError, :json_resp}}
      ],
      opts: opts
  ...
  **Content Types**: `application/json`
  ...
  """
  @spec query_metric_aggregates(body :: Klaviyo.MetricAggregateQuery.t(), opts :: keyword) ::
          {:ok, Klaviyo.PostMetricAggregateResponse.t()}
          | {:error, Klaviyo.ClientError.json_resp() | Klaviyo.ServerError.json_resp()}
  def query_metric_aggregates(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Klaviyo.Metrics, :query_metric_aggregates},
      url: "/api/metric-aggregates/",
      body: body,
      method: :post,
      request: [{"application/json", {Klaviyo.MetricAggregateQuery, :t}}],
      response: [
        {200, {Klaviyo.PostMetricAggregateResponse, :t}},
        {"4XX", {Klaviyo.ClientError, :json_resp}},
        {"5XX", {Klaviyo.ServerError, :json_resp}}
      ],
      opts: opts
