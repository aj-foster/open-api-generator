defmodule PatchCampaignResponseDataRelationships do
  ...
  @type t :: %__MODULE__{
          "campaign-messages": PatchCampaignResponseDataRelationshipsCampaignMessages.t() | nil,
  ...
  def __fields__(:t) do
    [
      "campaign-messages": {PatchCampaignResponseDataRelationshipsCampaignMessages, :t},
