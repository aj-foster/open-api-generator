defmodule Klaviyo.GetTagResponseCompoundDocumentDataRelationshipsTagGroup do
  @moduledoc """
  Provides struct and type for a GetTagResponseCompoundDocumentDataRelationshipsTagGroup
  """

  @type t :: %__MODULE__{
          data: Klaviyo.GetTagResponseCompoundDocumentDataRelationshipsTagGroupData.t(),
