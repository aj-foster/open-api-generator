defmodule Klaviyo.Events do
  ...
  **Content Types**: `application/json`
  """
  @spec create_event(body :: Klaviyo.EventCreateQueryV2.t(), opts :: keyword) ::
  ...
  def create_event(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Klaviyo.Events, :create_event},
      url: "/api/events/",
      body: body,
      method: :post,
  ...
  **Scopes:**
  ...
  """
  @spec get_event(id :: String.t(), opts :: keyword) ::
          {:ok, Klaviyo.GetEventResponseCompoundDocument.t()}
  ...
  def get_event(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Klaviyo.Events, :get_event},
      url: "/api/events/#{id}/",
      method: :get,
      query: query,
      response: [
        {200, {Klaviyo.GetEventResponseCompoundDocument, :t}},
        {"4XX", {Klaviyo.ClientError, :json_resp}},
        {"5XX", {Klaviyo.ServerError, :json_resp}}
      ],
      opts: opts
  ...
  **Scopes:**
  ...
  """
  @spec get_event_metric(id :: String.t(), opts :: keyword) ::
          {:ok, Klaviyo.GetMetricResponse.t()}
          | {:error, Klaviyo.ClientError.json_resp() | Klaviyo.ServerError.json_resp()}
  def get_event_metric(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Klaviyo.Events, :get_event_metric},
      url: "/api/events/#{id}/metric/",
      method: :get,
      query: query,
      response: [
        {200, {Klaviyo.GetMetricResponse, :t}},
        {"4XX", {Klaviyo.ClientError, :json_resp}},
        {"5XX", {Klaviyo.ServerError, :json_resp}}
      ],
      opts: opts
  ...
  **Scopes:**
  ...
  """
  @spec get_event_profile(id :: String.t(), opts :: keyword) ::
          {:ok, Klaviyo.GetProfileResponse.t()}
          | {:error, Klaviyo.ClientError.json_resp() | Klaviyo.ServerError.json_resp()}
  def get_event_profile(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Klaviyo.Events, :get_event_profile},
      url: "/api/events/#{id}/profile/",
      method: :get,
      query: query,
      response: [
        {200, {Klaviyo.GetProfileResponse, :t}},
        {"4XX", {Klaviyo.ClientError, :json_resp}},
        {"5XX", {Klaviyo.ServerError, :json_resp}}
      ],
      opts: opts
  ...
  **Scopes:**
  ...
  `metrics:read`
  """
  @spec get_event_relationships_metric(id :: String.t(), opts :: keyword) ::
          {:ok, Klaviyo.GetEventMetricsRelationshipListResponse.t()}
          | {:error, Klaviyo.ClientError.json_resp() | Klaviyo.ServerError.json_resp()}
  def get_event_relationships_metric(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Klaviyo.Events, :get_event_relationships_metric},
      url: "/api/events/#{id}/relationships/metric/",
      method: :get,
      response: [
        {200, {Klaviyo.GetEventMetricsRelationshipListResponse, :t}},
        {"4XX", {Klaviyo.ClientError, :json_resp}},
        {"5XX", {Klaviyo.ServerError, :json_resp}}
      ],
      opts: opts
  ...
  **Scopes:**
  ...
  `profiles:read`
  """
  @spec get_event_relationships_profile(id :: String.t(), opts :: keyword) ::
          {:ok, Klaviyo.GetEventProfilesRelationshipListResponse.t()}
          | {:error, Klaviyo.ClientError.json_resp() | Klaviyo.ServerError.json_resp()}
  def get_event_relationships_profile(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Klaviyo.Events, :get_event_relationships_profile},
      url: "/api/events/#{id}/relationships/profile/",
      method: :get,
      response: [
        {200, {Klaviyo.GetEventProfilesRelationshipListResponse, :t}},
        {"4XX", {Klaviyo.ClientError, :json_resp}},
        {"5XX", {Klaviyo.ServerError, :json_resp}}
      ],
      opts: opts
  ...
  **Scopes:**
  ...
  @spec get_events(opts :: keyword) ::
          {:ok, Klaviyo.GetEventResponseCollectionCompoundDocument.t()}
          | {:error, Klaviyo.ClientError.json_resp() | Klaviyo.ServerError.json_resp()}
  def get_events(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Klaviyo.Events, :get_events},
      url: "/api/events/",
      method: :get,
      query: query,
      response: [
        {200, {Klaviyo.GetEventResponseCollectionCompoundDocument, :t}},
        {"4XX", {Klaviyo.ClientError, :json_resp}},
        {"5XX", {Klaviyo.ServerError, :json_resp}}
      ],
      opts: opts
