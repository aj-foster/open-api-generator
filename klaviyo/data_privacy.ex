defmodule Klaviyo.DataPrivacy do
  ...
  **Content Types**: `application/json`
  """
  @spec request_profile_deletion(
          body :: Klaviyo.DataPrivacyCreateDeletionJobQuery.t(),
          opts :: keyword
  ...
  def request_profile_deletion(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Klaviyo.DataPrivacy, :request_profile_deletion},
      url: "/api/data-privacy-deletion-jobs/",
      body: body,
      method: :post,
      request: [{"application/json", {Klaviyo.DataPrivacyCreateDeletionJobQuery, :t}}],
      response: [
        {202, :null},
