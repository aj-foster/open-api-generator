defmodule Coupons do
  ...
  **Content Types**: `application/json`
  """
  @spec create_coupon(body :: CouponCreateQuery.t(), opts :: keyword) ::
  ...
  **Content Types**: `application/json`
  """
  @spec create_coupon_code(body :: CouponCodeCreateQuery.t(), opts :: keyword) ::
  ...
  **Content Types**: `application/json`
  ...
  @spec spawn_coupon_code_bulk_create_job(
          body :: CouponCodeCreateJobCreateQuery.t(),
          opts :: keyword
        ) ::
  ...
  **Content Types**: `application/json`
  """
  @spec update_coupon(id :: String.t(), body :: CouponUpdateQuery.t(), opts :: keyword) ::
  ...
  **Content Types**: `application/json`
  """
  @spec update_coupon_code(id :: String.t(), body :: CouponCodeUpdateQuery.t(), opts :: keyword) ::
