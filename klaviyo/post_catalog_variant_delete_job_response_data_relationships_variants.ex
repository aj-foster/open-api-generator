defmodule Klaviyo.PostCatalogVariantDeleteJobResponseDataRelationshipsVariants do
  @moduledoc """
  Provides struct and type for a PostCatalogVariantDeleteJobResponseDataRelationshipsVariants
  """

  @type t :: %__MODULE__{
          data: [Klaviyo.PostCatalogVariantDeleteJobResponseDataRelationshipsVariantsData.t()],
