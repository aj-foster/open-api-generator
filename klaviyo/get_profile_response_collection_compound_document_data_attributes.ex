defmodule Klaviyo.GetProfileResponseCollectionCompoundDocumentDataAttributes do
  @moduledoc """
  Provides struct and type for a GetProfileResponseCollectionCompoundDocumentDataAttributes
  """
