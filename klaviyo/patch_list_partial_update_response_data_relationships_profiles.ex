defmodule Klaviyo.PatchListPartialUpdateResponseDataRelationshipsProfiles do
  @moduledoc """
  Provides struct and type for a PatchListPartialUpdateResponseDataRelationshipsProfiles
  """

  @type t :: %__MODULE__{
          data: [Klaviyo.PatchListPartialUpdateResponseDataRelationshipsProfilesData.t()],
