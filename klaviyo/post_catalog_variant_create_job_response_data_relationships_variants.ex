defmodule Klaviyo.PostCatalogVariantCreateJobResponseDataRelationshipsVariants do
  @moduledoc """
  Provides struct and type for a PostCatalogVariantCreateJobResponseDataRelationshipsVariants
  """

  @type t :: %__MODULE__{
          data: [Klaviyo.PostCatalogVariantCreateJobResponseDataRelationshipsVariantsData.t()],
