defmodule Images do
  ...
  **Scopes:**
  `images:write`
  """
  @spec update_image(id :: String.t(), body :: ImagePartialUpdateQuery.t(), opts :: keyword) ::
  ...
  **Scopes:**
  `images:write`
  """
  @spec upload_image_from_file(body :: ImageUploadQuery.t(), opts :: keyword) ::
  ...
  **Scopes:**
  `images:write`
  """
  @spec upload_image_from_url(body :: ImageCreateQuery.t(), opts :: keyword) ::
          {:ok, PostImageResponse.t()}
          | {:error, ClientError.json_resp() | ServerError.json_resp()}
