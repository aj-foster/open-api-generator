defmodule Klaviyo.Images do
  ...
  **Scopes:**
  ...
  """
  @spec get_image(id :: String.t(), opts :: keyword) ::
          {:ok, Klaviyo.GetImageResponse.t()}
  ...
  def get_image(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Klaviyo.Images, :get_image},
      url: "/api/images/#{id}/",
      method: :get,
      query: query,
      response: [
        {200, {Klaviyo.GetImageResponse, :t}},
  ...
  **Scopes:**
  ...
  """
  @spec get_images(opts :: keyword) ::
          {:ok, Klaviyo.GetImageResponseCollection.t()}
          | {:error, Klaviyo.ClientError.json_resp() | Klaviyo.ServerError.json_resp()}
  def get_images(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Klaviyo.Images, :get_images},
      url: "/api/images/",
      method: :get,
      query: query,
      response: [
        {200, {Klaviyo.GetImageResponseCollection, :t}},
        {"4XX", {Klaviyo.ClientError, :json_resp}},
        {"5XX", {Klaviyo.ServerError, :json_resp}}
      ],
      opts: opts
  ...
  **Content Types**: `application/json`
  ...
  @spec update_image(
          id :: String.t(),
          body :: Klaviyo.ImagePartialUpdateQuery.t(),
          opts :: keyword
        ) ::
          {:ok, Klaviyo.PatchImageResponse.t()}
          | {:error, Klaviyo.ClientError.json_resp() | Klaviyo.ServerError.json_resp()}
  def update_image(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Klaviyo.Images, :update_image},
      url: "/api/images/#{id}/",
      body: body,
      method: :patch,
      request: [{"application/json", {Klaviyo.ImagePartialUpdateQuery, :t}}],
      response: [
        {200, {Klaviyo.PatchImageResponse, :t}},
        {"4XX", {Klaviyo.ClientError, :json_resp}},
        {"5XX", {Klaviyo.ServerError, :json_resp}}
      ],
      opts: opts
  ...
  **Content Types**: `multipart/form-data`
  """
  @spec upload_image_from_file(body :: Klaviyo.ImageUploadQuery.t(), opts :: keyword) ::
          {:ok, Klaviyo.PostImageResponse.t()}
          | {:error, Klaviyo.ClientError.json_resp() | Klaviyo.ServerError.json_resp()}
  def upload_image_from_file(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Klaviyo.Images, :upload_image_from_file},
      url: "/api/image-upload/",
      body: body,
      method: :post,
      request: [{"multipart/form-data", {Klaviyo.ImageUploadQuery, :t}}],
      response: [
        {201, {Klaviyo.PostImageResponse, :t}},
        {"4XX", {Klaviyo.ClientError, :json_resp}},
        {"5XX", {Klaviyo.ServerError, :json_resp}}
      ],
      opts: opts
  ...
  **Content Types**: `application/json`
  """
  @spec upload_image_from_url(body :: Klaviyo.ImageCreateQuery.t(), opts :: keyword) ::
          {:ok, Klaviyo.PostImageResponse.t()}
          | {:error, Klaviyo.ClientError.json_resp() | Klaviyo.ServerError.json_resp()}
  def upload_image_from_url(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Klaviyo.Images, :upload_image_from_url},
      url: "/api/images/",
      body: body,
      method: :post,
      request: [{"application/json", {Klaviyo.ImageCreateQuery, :t}}],
      response: [
        {201, {Klaviyo.PostImageResponse, :t}},
        {"4XX", {Klaviyo.ClientError, :json_resp}},
        {"5XX", {Klaviyo.ServerError, :json_resp}}
