defmodule GetCouponCodeCreateJobResponseCompoundDocumentDataRelationships do
  ...
  @type t :: %__MODULE__{
          "coupon-codes":
            GetCouponCodeCreateJobResponseCompoundDocumentDataRelationshipsCouponCodes.t() | nil
        }
  ...
  def __fields__(:t) do
    [
      "coupon-codes":
        {GetCouponCodeCreateJobResponseCompoundDocumentDataRelationshipsCouponCodes, :t}
    ]
  end
end
