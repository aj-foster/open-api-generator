defmodule Klaviyo.GetFlowResponseCompoundDocumentDataRelationshipsFlowActions do
  @moduledoc """
  Provides struct and type for a GetFlowResponseCompoundDocumentDataRelationshipsFlowActions
  """

  @type t :: %__MODULE__{
          data: [Klaviyo.GetFlowResponseCompoundDocumentDataRelationshipsFlowActionsData.t()],
