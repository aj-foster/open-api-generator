defmodule Lists do
  ...
  **Content Types**: `application/json`
  """
  @spec create_list(body :: ListCreateQuery.t(), opts :: keyword) ::
  ...
  **Content Types**: `application/json`
  """
  @spec update_list(id :: String.t(), body :: ListPartialUpdateQuery.t(), opts :: keyword) ::
