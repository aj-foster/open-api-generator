defmodule Klaviyo.Lists do
  ...
  **Content Types**: `application/json`
  """
  @spec create_list(body :: Klaviyo.ListCreateQuery.t(), opts :: keyword) ::
          {:ok, Klaviyo.PostListCreateResponse.t()}
  ...
  def create_list(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Klaviyo.Lists, :create_list},
      url: "/api/lists/",
      body: body,
      method: :post,
      request: [{"application/json", {Klaviyo.ListCreateQuery, :t}}],
      response: [
        {201, {Klaviyo.PostListCreateResponse, :t}},
  ...
  **Content Types**: `application/json`
  """
  @spec create_list_relationships(
          id :: String.t(),
          body :: Klaviyo.ListMembersAddQuery.t(),
          opts :: keyword
  ...
  def create_list_relationships(id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Klaviyo.Lists, :create_list_relationships},
      url: "/api/lists/#{id}/relationships/profiles/",
      body: body,
      method: :post,
      request: [{"application/json", {Klaviyo.ListMembersAddQuery, :t}}],
      response: [
        {204, :null},
        {"4XX", {Klaviyo.ClientError, :json_resp}},
        {"5XX", {Klaviyo.ServerError, :json_resp}}
  ...
  **Scopes:**
  `lists:write`
  """
  @spec delete_list(id :: String.t(), opts :: keyword) ::
          :ok | {:error, Klaviyo.ClientError.json_resp() | Klaviyo.ServerError.json_resp()}
  def delete_list(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Klaviyo.Lists, :delete_list},
      url: "/api/lists/#{id}/",
      method: :delete,
      response: [
        {204, :null},
  ...
  **Content Types**: `application/json`
  """
  @spec delete_list_relationships(
          id :: String.t(),
          body :: Klaviyo.ListMembersDeleteQuery.t(),
          opts :: keyword
        ) :: :ok | {:error, Klaviyo.ClientError.json_resp() | Klaviyo.ServerError.json_resp()}
  def delete_list_relationships(id, body, opts \\ []) do
    ...
    client.request(%{
      args: [id: id, body: body],
      call: {Klaviyo.Lists, :delete_list_relationships},
      url: "/api/lists/#{id}/relationships/profiles/",
      body: body,
      method: :delete,
      request: [{"application/json", {Klaviyo.ListMembersDeleteQuery, :t}}],
      response: [
        {204, :null},
        {"4XX", {Klaviyo.ClientError, :json_resp}},
        {"5XX", {Klaviyo.ServerError, :json_resp}}
  ...
  **Scopes:**
  ...
  """
  @spec get_list(id :: String.t(), opts :: keyword) ::
          {:ok, Klaviyo.GetListRetrieveResponseCompoundDocument.t()}
          | {:error, Klaviyo.ClientError.json_resp() | Klaviyo.ServerError.json_resp()}
  def get_list(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Klaviyo.Lists, :get_list},
      url: "/api/lists/#{id}/",
      method: :get,
      query: query,
      response: [
        {200, {Klaviyo.GetListRetrieveResponseCompoundDocument, :t}},
        {"4XX", {Klaviyo.ClientError, :json_resp}},
        {"5XX", {Klaviyo.ServerError, :json_resp}}
      ],
      opts: opts
  ...
  **Scopes:**
  ...
  """
  @spec get_list_profiles(id :: String.t(), opts :: keyword) ::
          {:ok, Klaviyo.GetListMemberResponseCollection.t()}
          | {:error, Klaviyo.ClientError.json_resp() | Klaviyo.ServerError.json_resp()}
  def get_list_profiles(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Klaviyo.Lists, :get_list_profiles},
      url: "/api/lists/#{id}/profiles/",
      method: :get,
      query: query,
      response: [
        {200, {Klaviyo.GetListMemberResponseCollection, :t}},
        {"4XX", {Klaviyo.ClientError, :json_resp}},
        {"5XX", {Klaviyo.ServerError, :json_resp}}
      ],
      opts: opts
  ...
  **Scopes:**
  ...
  """
  @spec get_list_relationships_profiles(id :: String.t(), opts :: keyword) ::
          {:ok, Klaviyo.GetListRelationshipsResponseCollection.t()}
          | {:error, Klaviyo.ClientError.json_resp() | Klaviyo.ServerError.json_resp()}
  def get_list_relationships_profiles(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Klaviyo.Lists, :get_list_relationships_profiles},
      url: "/api/lists/#{id}/relationships/profiles/",
      method: :get,
      query: query,
      response: [
        {200, {Klaviyo.GetListRelationshipsResponseCollection, :t}},
        {"4XX", {Klaviyo.ClientError, :json_resp}},
        {"5XX", {Klaviyo.ServerError, :json_resp}}
      ],
      opts: opts
  ...
  **Scopes:**
  ...
  `tags:read`
  """
  @spec get_list_relationships_tags(id :: String.t(), opts :: keyword) ::
          {:ok, Klaviyo.GetListTagRelationshipListResponseCollection.t()}
          | {:error, Klaviyo.ClientError.json_resp() | Klaviyo.ServerError.json_resp()}
  def get_list_relationships_tags(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Klaviyo.Lists, :get_list_relationships_tags},
      url: "/api/lists/#{id}/relationships/tags/",
      method: :get,
      response: [
        {200, {Klaviyo.GetListTagRelationshipListResponseCollection, :t}},
        {"4XX", {Klaviyo.ClientError, :json_resp}},
        {"5XX", {Klaviyo.ServerError, :json_resp}}
      ],
      opts: opts
  ...
  **Scopes:**
  ...
  """
  @spec get_list_tags(id :: String.t(), opts :: keyword) ::
  ...
  def get_list_tags(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Klaviyo.Lists, :get_list_tags},
  ...
  **Scopes:**
  ...
  """
  @spec get_lists(opts :: keyword) ::
          {:ok, Klaviyo.GetListListResponseCollectionCompoundDocument.t()}
          | {:error, Klaviyo.ClientError.json_resp() | Klaviyo.ServerError.json_resp()}
  def get_lists(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Klaviyo.Lists, :get_lists},
      url: "/api/lists/",
      method: :get,
      query: query,
      response: [
        {200, {Klaviyo.GetListListResponseCollectionCompoundDocument, :t}},
        {"4XX", {Klaviyo.ClientError, :json_resp}},
        {"5XX", {Klaviyo.ServerError, :json_resp}}
      ],
      opts: opts
  ...
  **Content Types**: `application/json`
  """
  @spec update_list(id :: String.t(), body :: Klaviyo.ListPartialUpdateQuery.t(), opts :: keyword) ::
          {:ok, Klaviyo.PatchListPartialUpdateResponse.t()}
          | {:error, Klaviyo.ClientError.json_resp() | Klaviyo.ServerError.json_resp()}
  def update_list(id, body, opts \\ []) do
    ...
    client.request(%{
      args: [id: id, body: body],
      call: {Klaviyo.Lists, :update_list},
      url: "/api/lists/#{id}/",
      body: body,
      method: :patch,
      request: [{"application/json", {Klaviyo.ListPartialUpdateQuery, :t}}],
      response: [
        {200, {Klaviyo.PatchListPartialUpdateResponse, :t}},
        {"4XX", {Klaviyo.ClientError, :json_resp}},
        {"5XX", {Klaviyo.ServerError, :json_resp}}
      ],
      opts: opts
