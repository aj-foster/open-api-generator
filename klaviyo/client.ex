defmodule Client do
  ...
  **Scopes:**
  ...
  """
  @spec bulk_create_client_events(body :: EventsBulkCreateQuery.t(), opts :: keyword) ::
  ...
  **Scopes:**
  ...
  @spec create_client_back_in_stock_subscription(
          body :: ClientBISSubscriptionCreateQuery.t(),
          opts :: keyword
        ) :: :ok | {:error, ClientError.json_resp() | ServerError.json_resp()}
  ...
  **Scopes:**
  ...
  """
  @spec create_client_event(body :: EventCreateQueryV2.t(), opts :: keyword) ::
          :ok | {:error, ClientError.json_resp() | ServerError.json_resp()}
  ...
  **Scopes:**
  ...
  """
  @spec create_client_profile(body :: OnsiteProfileCreateQuery.t(), opts :: keyword) ::
          :ok | {:error, ClientError.json_resp() | ServerError.json_resp()}
  ...
  """
  @spec create_client_push_token(body :: PushTokenCreateQuery.t(), opts :: keyword) ::
          :ok | {:error, ClientError.json_resp() | ServerError.json_resp()}
  ...
  **Scopes:**
  ...
  """
  @spec create_client_subscription(body :: OnsiteSubscriptionCreateQuery.t(), opts :: keyword) ::
          :ok | :error
  ...
  """
  @spec unregister_client_push_token(body :: PushTokenUnregisterQuery.t(), opts :: keyword) ::
          :ok | {:error, ClientError.json_resp() | ServerError.json_resp()}
