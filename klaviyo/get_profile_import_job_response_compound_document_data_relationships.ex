defmodule GetProfileImportJobResponseCompoundDocumentDataRelationships do
  ...
  @type t :: %__MODULE__{
          "import-errors":
            GetProfileImportJobResponseCompoundDocumentDataRelationshipsImportErrors.t() | nil,
  ...
  def __fields__(:t) do
    [
      "import-errors":
        {GetProfileImportJobResponseCompoundDocumentDataRelationshipsImportErrors, :t},
