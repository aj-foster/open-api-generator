defmodule Klaviyo.GetEventResponseCompoundDocumentDataRelationshipsMetric do
  @moduledoc """
  Provides struct and type for a GetEventResponseCompoundDocumentDataRelationshipsMetric
  """

  @type t :: %__MODULE__{
          data: Klaviyo.GetEventResponseCompoundDocumentDataRelationshipsMetricData.t(),
