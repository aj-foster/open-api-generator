defmodule Klaviyo.GetEventResponseCompoundDocumentDataRelationshipsProfile do
  @moduledoc """
  Provides struct and type for a GetEventResponseCompoundDocumentDataRelationshipsProfile
  """

  @type t :: %__MODULE__{
          data: Klaviyo.GetEventResponseCompoundDocumentDataRelationshipsProfileData.t(),
