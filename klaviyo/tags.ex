defmodule Tags do
  ...
  **Scopes:**
  ...
  `tags:write`
  """
  @spec create_tag(body :: TagCreateQuery.t(), opts :: keyword) ::
  ...
  **Scopes:**
  ...
  `tags:write`
  """
  @spec create_tag_group(body :: TagGroupCreateQuery.t(), opts :: keyword) ::
  ...
  **Scopes:**
  ...
  `tags:write`
  """
  @spec create_tag_relationships_flows(id :: String.t(), body :: TagFlowOp.t(), opts :: keyword) ::
          :ok | {:error, ClientError.json_resp() | ServerError.json_resp()}
  ...
  **Scopes:**
  ...
  `tags:write`
  """
  @spec create_tag_relationships_lists(id :: String.t(), body :: TagListOp.t(), opts :: keyword) ::
          :ok | {:error, ClientError.json_resp() | ServerError.json_resp()}
  ...
  **Scopes:**
  ...
  `tags:write`
  """
  @spec delete_tag_relationships_flows(id :: String.t(), body :: TagFlowOp.t(), opts :: keyword) ::
          :ok | {:error, ClientError.json_resp() | ServerError.json_resp()}
  ...
  **Scopes:**
  ...
  `tags:write`
  """
  @spec delete_tag_relationships_lists(id :: String.t(), body :: TagListOp.t(), opts :: keyword) ::
          :ok | {:error, ClientError.json_resp() | ServerError.json_resp()}
  ...
  **Scopes:**
  ...
  `tags:write`
  """
  @spec update_tag(id :: String.t(), body :: TagUpdateQuery.t(), opts :: keyword) ::
          :ok | {:error, ClientError.json_resp() | ServerError.json_resp()}
  ...
  **Scopes:**
  ...
  `tags:write`
  """
  @spec update_tag_group(id :: String.t(), body :: TagGroupUpdateQuery.t(), opts :: keyword) ::
