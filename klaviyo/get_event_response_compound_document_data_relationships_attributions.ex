defmodule Klaviyo.GetEventResponseCompoundDocumentDataRelationshipsAttributions do
  @moduledoc """
  Provides struct and type for a GetEventResponseCompoundDocumentDataRelationshipsAttributions
  """

  @type t :: %__MODULE__{
          data: [Klaviyo.GetEventResponseCompoundDocumentDataRelationshipsAttributionsData.t()],
