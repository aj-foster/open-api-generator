defmodule PostProfileImportJobResponseDataRelationships do
  ...
  @type t :: %__MODULE__{
          "import-errors": PostProfileImportJobResponseDataRelationshipsImportErrors.t() | nil,
  ...
  def __fields__(:t) do
    [
      "import-errors": {PostProfileImportJobResponseDataRelationshipsImportErrors, :t},
