defmodule Klaviyo.Accounts do
  ...
  **Scopes:**
  ...
  """
  @spec get_account(id :: String.t(), opts :: keyword) ::
          {:ok, Klaviyo.GetAccountResponse.t()}
  ...
  def get_account(id, opts \\ []) do
    ...
    client.request(%{
      args: [id: id],
      call: {Klaviyo.Accounts, :get_account},
      url: "/api/accounts/#{id}/",
      method: :get,
      query: query,
      response: [
        {200, {Klaviyo.GetAccountResponse, :t}},
  ...
  **Scopes:**
  ...
  """
  @spec get_accounts(opts :: keyword) ::
          {:ok, Klaviyo.GetAccountResponseCollection.t()}
          | {:error, Klaviyo.ClientError.json_resp() | Klaviyo.ServerError.json_resp()}
  def get_accounts(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Klaviyo.Accounts, :get_accounts},
      url: "/api/accounts/",
      method: :get,
      query: query,
      response: [
        {200, {Klaviyo.GetAccountResponseCollection, :t}},
        {"4XX", {Klaviyo.ClientError, :json_resp}},
        {"5XX", {Klaviyo.ServerError, :json_resp}}
      ],
      opts: opts
