defmodule Klaviyo.PostCampaignValuesResponseDTODataRelationshipsCampaigns do
  @moduledoc """
  Provides struct and type for a PostCampaignValuesResponseDTODataRelationshipsCampaigns
  """

  @type t :: %__MODULE__{
          data: [Klaviyo.PostCampaignValuesResponseDTODataRelationshipsCampaignsData.t()],
