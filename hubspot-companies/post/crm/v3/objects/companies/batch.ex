defmodule HubSpot.Companies.Post.Crm.V3.Objects.Companies.Batch do
  @moduledoc """
  Provides API endpoints related to post/crm/v3/objects/companies/batch
  """
  ...
  **Content Types**: `application/json`
  ...
  def archive_archive(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {HubSpot.Companies.Post.Crm.V3.Objects.Companies.Batch, :archive_archive},
  ...
  **Content Types**: `application/json`
  ...
  def create_create(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {HubSpot.Companies.Post.Crm.V3.Objects.Companies.Batch, :create_create},
  ...
  **Content Types**: `application/json`
  ...
  def read_read(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {HubSpot.Companies.Post.Crm.V3.Objects.Companies.Batch, :read_read},
  ...
  **Content Types**: `application/json`
  ...
  def update_update(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {HubSpot.Companies.Post.Crm.V3.Objects.Companies.Batch, :update_update},
