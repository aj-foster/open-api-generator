defmodule Post.Crm.V3.Objects.Companies do
  ...
  **Content Types**: `application/json`
  """
  @spec gdpr_delete_purge(body :: PublicGdprDeleteInput.t(), opts :: keyword) ::
          :ok | {:error, Error.t()}
  ...
  **Content Types**: `application/json`
  """
  @spec merge_merge(body :: PublicMergeInput.t(), opts :: keyword) ::
  ...
  **Content Types**: `application/json`
  """
  @spec search_do_search(body :: PublicObjectSearchRequest.t(), opts :: keyword) ::
