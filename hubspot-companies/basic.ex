defmodule HubSpot.Companies.Basic do
  @moduledoc """
  ...
  **Content Types**: `application/json`
  ...
  def companies_create(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {HubSpot.Companies.Basic, :companies_create},
  ...
  """
  @spec companies_get_page(opts :: keyword) ::
          {:ok,
           HubSpot.Companies.CollectionResponseSimplePublicObjectWithAssociationsForwardPaging.t()}
  ...
  def companies_get_page(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {HubSpot.Companies.Basic, :companies_get_page},
      url: "/crm/v3/objects/companies",
      method: :get,
      query: query,
      response: [
  ...
  def company_id_archive(companyId, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {HubSpot.Companies.Basic, :company_id_archive},
  ...
  """
  @spec company_id_get_by_id(companyId :: String.t(), opts :: keyword) ::
          {:ok, HubSpot.Companies.SimplePublicObjectWithAssociations.t()}
          | {:error, HubSpot.Companies.Error.t()}
  def company_id_get_by_id(companyId, opts \\ []) do
    ...
    client.request(%{
      args: [companyId: companyId],
      call: {HubSpot.Companies.Basic, :company_id_get_by_id},
      url: "/crm/v3/objects/companies/#{companyId}",
      method: :get,
      query: query,
      response: [
        {200, {HubSpot.Companies.SimplePublicObjectWithAssociations, :t}},
        default: {HubSpot.Companies.Error, :t}
      ],
      opts: opts
    })
  ...
  **Content Types**: `application/json`
  """
  @spec company_id_update(
          companyId :: String.t(),
          body :: HubSpot.Companies.SimplePublicObjectInput.t(),
          opts :: keyword
        ) ::
          {:ok, HubSpot.Companies.SimplePublicObject.t()} | {:error, HubSpot.Companies.Error.t()}
  def company_id_update(companyId, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {HubSpot.Companies.Basic, :company_id_update},
      url: "/crm/v3/objects/companies/#{companyId}",
      body: body,
      method: :patch,
      query: query,
      request: [{"application/json", {HubSpot.Companies.SimplePublicObjectInput, :t}}],
      response: [
