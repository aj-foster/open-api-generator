defmodule Basic do
  ...
  **Content Types**: `application/json`
  """
  @spec companies_create(body :: SimplePublicObjectInputForCreate.t(), opts :: keyword) ::
  ...
  """
  @spec company_id_archive(companyId :: String.t(), opts :: keyword) :: :ok | {:error, Error.t()}
  ...
  **Content Types**: `application/json`
  ...
  @spec company_id_update(
          companyId :: String.t(),
          body :: SimplePublicObjectInput.t(),
          opts :: keyword
        ) :: {:ok, SimplePublicObject.t()} | {:error, Error.t()}
