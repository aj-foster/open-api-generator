defmodule Sentry.Projects do
  ...
  """
  @spec delete_a_specific_project_s_debug_information_file(
  ...
  def delete_a_specific_project_s_debug_information_file(
    ...
    client.request(%{
      ...
      call: {Sentry.Projects, :delete_a_specific_project_s_debug_information_file},
  ...
  **Content Types**: `application/json`
  """
  @spec disable_spike_protection(organization_id_or_slug :: String.t(), body :: map) ::
          :ok | :error
  @spec disable_spike_protection(
          organization_id_or_slug :: String.t(),
          body :: map,
          opts :: keyword
        ) :: :ok | :error
  def disable_spike_protection(organization_id_or_slug, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Sentry.Projects, :disable_spike_protection},
  ...
  **Content Types**: `application/json`
  """
  @spec enable_spike_protection(organization_id_or_slug :: String.t(), body :: map) ::
          :ok | :error
  @spec enable_spike_protection(
          organization_id_or_slug :: String.t(),
          body :: map,
          opts :: keyword
        ) :: :ok | :error
  def enable_spike_protection(organization_id_or_slug, body, opts \\ []) do
    ...
    client.request(%{
      args: [organization_id_or_slug: organization_id_or_slug, body: body],
      call: {Sentry.Projects, :enable_spike_protection},
      url: "/api/0/organizations/#{organization_id_or_slug}/spike-protections/",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
  ...
  """
  @spec list_a_project_s_debug_information_files(
          organization_id_or_slug :: String.t(),
          project_id_or_slug :: String.t()
        ) :: {:ok, any} | :error
  @spec list_a_project_s_debug_information_files(
  ...
  def list_a_project_s_debug_information_files(
    ...
    client.request(%{
      ...
      call: {Sentry.Projects, :list_a_project_s_debug_information_files},
      url: "/api/0/projects/#{organization_id_or_slug}/#{project_id_or_slug}/files/dsyms/",
      method: :get,
  ...
  """
  @spec list_a_project_s_service_hooks(
          organization_id_or_slug :: String.t(),
          project_id_or_slug :: String.t()
        ) :: {:ok, [Sentry.ServiceHook.t()]} | :error
  @spec list_a_project_s_service_hooks(
          organization_id_or_slug :: String.t(),
          project_id_or_slug :: String.t(),
          opts :: keyword
  ...
  def list_a_project_s_service_hooks(organization_id_or_slug, project_id_or_slug, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Sentry.Projects, :list_a_project_s_service_hooks},
      url: "/api/0/projects/#{organization_id_or_slug}/#{project_id_or_slug}/hooks/",
      method: :get,
      query: query,
      response: [{200, [{Sentry.ServiceHook, :t}]}, {403, :null}],
      opts: opts
    })
  end
  ...
  """
  @spec list_a_project_s_user_feedback(
          organization_id_or_slug :: String.t(),
          project_id_or_slug :: String.t()
        ) :: {:ok, [Sentry.UserFeedback.t()]} | :error
  @spec list_a_project_s_user_feedback(
          organization_id_or_slug :: String.t(),
          project_id_or_slug :: String.t(),
          opts :: keyword
  ...
  def list_a_project_s_user_feedback(organization_id_or_slug, project_id_or_slug, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Sentry.Projects, :list_a_project_s_user_feedback},
      url: "/api/0/projects/#{organization_id_or_slug}/#{project_id_or_slug}/user-feedback/",
      method: :get,
      response: [{200, [{Sentry.UserFeedback, :t}]}, {403, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  """
  @spec list_a_project_s_users(
          organization_id_or_slug :: String.t(),
          project_id_or_slug :: String.t()
        ) :: {:ok, [Sentry.Projects.list_a_project_s_users_200_json_resp()]} | :error
  @spec list_a_project_s_users(
          organization_id_or_slug :: String.t(),
          project_id_or_slug :: String.t(),
          opts :: keyword
  ...
  def list_a_project_s_users(organization_id_or_slug, project_id_or_slug, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Sentry.Projects, :list_a_project_s_users},
      url: "/api/0/projects/#{organization_id_or_slug}/#{project_id_or_slug}/users/",
      method: :get,
      query: query,
      response: [{200, [{Sentry.Projects, :list_a_project_s_users_200_json_resp}]}, {403, :null}],
      opts: opts
    })
  end
  ...
  """
  @spec list_a_tag_s_values(
          organization_id_or_slug :: String.t(),
          project_id_or_slug :: String.t(),
          key :: String.t()
        ) :: {:ok, [Sentry.Projects.list_a_tag_s_values_200_json_resp()]} | :error
  @spec list_a_tag_s_values(
          organization_id_or_slug :: String.t(),
          project_id_or_slug :: String.t(),
          key :: String.t(),
  ...
  def list_a_tag_s_values(organization_id_or_slug, project_id_or_slug, key, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Sentry.Projects, :list_a_tag_s_values},
      url: "/api/0/projects/#{organization_id_or_slug}/#{project_id_or_slug}/tags/#{key}/values/",
      method: :get,
      response: [{200, [{Sentry.Projects, :list_a_tag_s_values_200_json_resp}]}, {403, :null}],
      opts: opts
    })
  end
  ...
  """
  @spec list_your_projects() ::
          {:ok, [Sentry.Projects.list_your_projects_200_json_resp()]} | :error
  @spec list_your_projects(opts :: keyword) ::
          {:ok, [Sentry.Projects.list_your_projects_200_json_resp()]} | :error
  def list_your_projects(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {Sentry.Projects, :list_your_projects},
      url: "/api/0/projects/",
      method: :get,
      query: query,
      response: [{200, [{Sentry.Projects, :list_your_projects_200_json_resp}]}, {403, :null}],
      opts: opts
    })
  end
  ...
  **Content Types**: `application/json`
  """
  @spec register_a_new_service_hook(
          organization_id_or_slug :: String.t(),
          project_id_or_slug :: String.t(),
          body :: map
        ) :: {:ok, Sentry.ServiceHook.t()} | :error
  ...
  def register_a_new_service_hook(organization_id_or_slug, project_id_or_slug, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Sentry.Projects, :register_a_new_service_hook},
      url: "/api/0/projects/#{organization_id_or_slug}/#{project_id_or_slug}/hooks/",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [{201, {Sentry.ServiceHook, :t}}, {403, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  def remove_a_service_hook(organization_id_or_slug, project_id_or_slug, hook_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Sentry.Projects, :remove_a_service_hook},
  ...
  def retrieve_a_service_hook(organization_id_or_slug, project_id_or_slug, hook_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Sentry.Projects, :retrieve_a_service_hook},
      url: "/api/0/projects/#{organization_id_or_slug}/#{project_id_or_slug}/hooks/#{hook_id}/",
      method: :get,
      response: [{200, {Sentry.ServiceHook, :t}}, {403, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  """
  @spec retrieve_event_counts_for_a_project(
          organization_id_or_slug :: String.t(),
          project_id_or_slug :: String.t()
        ) :: {:ok, [[integer]]} | :error
  @spec retrieve_event_counts_for_a_project(
  ...
  def retrieve_event_counts_for_a_project(organization_id_or_slug, project_id_or_slug, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Sentry.Projects, :retrieve_event_counts_for_a_project},
  ...
  **Content Types**: `application/json`
  ...
  def submit_user_feedback(organization_id_or_slug, project_id_or_slug, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Sentry.Projects, :submit_user_feedback},
      url: "/api/0/projects/#{organization_id_or_slug}/#{project_id_or_slug}/user-feedback/",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
      response: [
        {200, {Sentry.UserFeedback, :t}},
        {400, :null},
        {403, :null},
        {404, :null},
        {409, :null}
  ...
  **Content Types**: `application/json`
  ...
  def update_a_service_hook(
    ...
    client.request(%{
      ...
      call: {Sentry.Projects, :update_a_service_hook},
      url: "/api/0/projects/#{organization_id_or_slug}/#{project_id_or_slug}/hooks/#{hook_id}/",
      body: body,
      method: :put,
      request: [{"application/json", :map}],
      response: [{200, {Sentry.ServiceHook, :t}}, {400, :null}, {403, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  **Content Types**: `multipart/form-data`
  ...
  def upload_a_new_file(organization_id_or_slug, project_id_or_slug, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Sentry.Projects, :upload_a_new_file},
      url: "/api/0/projects/#{organization_id_or_slug}/#{project_id_or_slug}/files/dsyms/",
      body: body,
      method: :post,
