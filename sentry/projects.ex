defmodule Projects do
  ...
  @spec list_a_project_s_users(
          ...
          project_id_or_slug :: String.t(),
          opts :: keyword
        ) :: {:ok, [Projects.list_a_project_s_users_200_json_resp()]} | :error
  ...
  @spec list_a_tag_s_values(
          ...
          key :: String.t(),
          opts :: keyword
        ) :: {:ok, [Projects.list_a_tag_s_values_200_json_resp()]} | :error
  ...
  @spec list_your_projects(opts :: keyword) ::
          {:ok, [Projects.list_your_projects_200_json_resp()]} | :error
