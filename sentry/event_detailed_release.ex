defmodule Sentry.EventDetailedRelease do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
          ...
          id: integer | nil,
          lastCommit: map | nil,
          lastDeploy: Sentry.Deploy.t() | String.t() | nil,
  ...
  def __fields__(:t) do
    [
      authors: [:map],
      commitCount: {:integer, "int64"},
      data: :map,
      dateCreated: {:string, "date-time"},
      dateReleased: {:string, "date-time"},
      deployCount: {:integer, "int64"},
      firstEvent: {:string, "date-time"},
      id: :integer,
      lastCommit: :map,
      lastDeploy: {:union, [:string, {Sentry.Deploy, :t}]},
      lastEvent: {:string, "date-time"},
      newGroups: {:integer, "int64"},
      owner: :map,
      projects: [:map],
      ref: :string,
      shortVersion: :string,
