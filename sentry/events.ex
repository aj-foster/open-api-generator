defmodule Sentry.Events do
  ...
  **Content Types**: `application/json`
  """
  @spec bulk_mutate_a_list_of_issues(
          organization_id_or_slug :: String.t(),
          project_id_or_slug :: String.t(),
          body :: map
        ) :: {:ok, Sentry.Events.bulk_mutate_a_list_of_issues_200_json_resp()} | :error
  @spec bulk_mutate_a_list_of_issues(
          organization_id_or_slug :: String.t(),
          project_id_or_slug :: String.t(),
          body :: map,
  ...
  def bulk_mutate_a_list_of_issues(organization_id_or_slug, project_id_or_slug, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Sentry.Events, :bulk_mutate_a_list_of_issues},
      ...
      response: [
        {200, {Sentry.Events, :bulk_mutate_a_list_of_issues_200_json_resp}},
        {400, :null},
        {403, :null},
        {404, :null}
      ],
  ...
  """
  @spec bulk_remove_a_list_of_issues(
          organization_id_or_slug :: String.t(),
          project_id_or_slug :: String.t()
        ) :: :ok | :error
  @spec bulk_remove_a_list_of_issues(
  ...
  def bulk_remove_a_list_of_issues(organization_id_or_slug, project_id_or_slug, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Sentry.Events, :bulk_remove_a_list_of_issues},
      url: "/api/0/projects/#{organization_id_or_slug}/#{project_id_or_slug}/issues/",
      method: :delete,
      query: query,
  ...
  """
  @spec list_a_project_s_error_events(
          organization_id_or_slug :: String.t(),
          project_id_or_slug :: String.t()
        ) :: {:ok, [Sentry.Event.t()]} | :error
  @spec list_a_project_s_error_events(
          organization_id_or_slug :: String.t(),
          project_id_or_slug :: String.t(),
          opts :: keyword
  ...
  def list_a_project_s_error_events(organization_id_or_slug, project_id_or_slug, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Sentry.Events, :list_a_project_s_error_events},
      url: "/api/0/projects/#{organization_id_or_slug}/#{project_id_or_slug}/events/",
      method: :get,
      query: query,
      response: [{200, [{Sentry.Event, :t}]}, {403, :null}],
      opts: opts
    })
  end
  ...
  """
  @spec list_a_project_s_issues(
          organization_id_or_slug :: String.t(),
          project_id_or_slug :: String.t()
        ) :: {:ok, [Sentry.Issue.t()]} | :error
  @spec list_a_project_s_issues(
          organization_id_or_slug :: String.t(),
          project_id_or_slug :: String.t(),
          opts :: keyword
  ...
  def list_a_project_s_issues(organization_id_or_slug, project_id_or_slug, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Sentry.Events, :list_a_project_s_issues},
      url: "/api/0/projects/#{organization_id_or_slug}/#{project_id_or_slug}/issues/",
      method: :get,
      query: query,
      response: [{200, [{Sentry.Issue, :t}]}, {403, :null}],
      opts: opts
    })
  end
  ...
  """
  @spec list_a_tag_s_values_related_to_an_issue(
          organization_id_or_slug :: String.t(),
          issue_id :: String.t(),
          key :: String.t()
        ) ::
          {:ok, [Sentry.Events.list_a_tag_s_values_related_to_an_issue_200_json_resp()]} | :error
  @spec list_a_tag_s_values_related_to_an_issue(
          organization_id_or_slug :: String.t(),
          issue_id :: String.t(),
          key :: String.t(),
  ...
  def list_a_tag_s_values_related_to_an_issue(organization_id_or_slug, issue_id, key, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Sentry.Events, :list_a_tag_s_values_related_to_an_issue},
      url:
        "/api/0/organizations/#{organization_id_or_slug}/issues/#{issue_id}/tags/#{key}/values/",
      method: :get,
      response: [
        {200, [{Sentry.Events, :list_a_tag_s_values_related_to_an_issue_200_json_resp}]},
        {403, :null}
      ],
      opts: opts
    })
  ...
  """
  @spec list_an_issue_s_events(organization_id_or_slug :: String.t(), issue_id :: String.t()) ::
          {:ok, [Sentry.Event.t()]} | :error
  @spec list_an_issue_s_events(
          organization_id_or_slug :: String.t(),
          issue_id :: String.t(),
          opts :: keyword
        ) :: {:ok, [Sentry.Event.t()]} | :error
  def list_an_issue_s_events(organization_id_or_slug, issue_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Sentry.Events, :list_an_issue_s_events},
  ...
  """
  @spec list_an_issue_s_hashes(organization_id_or_slug :: String.t(), issue_id :: String.t()) ::
          {:ok, [Sentry.Events.list_an_issue_s_hashes_200_json_resp()]} | :error
  @spec list_an_issue_s_hashes(
          organization_id_or_slug :: String.t(),
          issue_id :: String.t(),
          opts :: keyword
        ) :: {:ok, [Sentry.Events.list_an_issue_s_hashes_200_json_resp()]} | :error
  def list_an_issue_s_hashes(organization_id_or_slug, issue_id, opts \\ []) do
    ...
    client.request(%{
      args: [organization_id_or_slug: organization_id_or_slug, issue_id: issue_id],
      call: {Sentry.Events, :list_an_issue_s_hashes},
      url: "/api/0/organizations/#{organization_id_or_slug}/issues/#{issue_id}/hashes/",
      method: :get,
      query: query,
      response: [{200, [{Sentry.Events, :list_an_issue_s_hashes_200_json_resp}]}, {403, :null}],
      opts: opts
    })
  end
  ...
  """
  @spec remove_an_issue(organization_id_or_slug :: String.t(), issue_id :: String.t()) ::
          :ok | :error
  @spec remove_an_issue(
          organization_id_or_slug :: String.t(),
          issue_id :: String.t(),
          opts :: keyword
        ) :: :ok | :error
  def remove_an_issue(organization_id_or_slug, issue_id, opts \\ []) do
    ...
    client.request(%{
      args: [organization_id_or_slug: organization_id_or_slug, issue_id: issue_id],
      call: {Sentry.Events, :remove_an_issue},
  ...
  """
  @spec retrieve_an_event_for_a_project(
          organization_id_or_slug :: String.t(),
          project_id_or_slug :: String.t(),
          event_id :: String.t()
        ) :: {:ok, Sentry.EventDetailed.t()} | :error
  @spec retrieve_an_event_for_a_project(
          organization_id_or_slug :: String.t(),
          project_id_or_slug :: String.t(),
          event_id :: String.t(),
  ...
  def retrieve_an_event_for_a_project(
    ...
    client.request(%{
      ...
      call: {Sentry.Events, :retrieve_an_event_for_a_project},
      url: "/api/0/projects/#{organization_id_or_slug}/#{project_id_or_slug}/events/#{event_id}/",
      method: :get,
      response: [{200, {Sentry.EventDetailed, :t}}, {403, :null}],
      opts: opts
    })
  end
  ...
  """
  @spec retrieve_an_issue(organization_id_or_slug :: String.t(), issue_id :: String.t()) ::
          {:ok, Sentry.IssueDetailed.t()} | :error
  @spec retrieve_an_issue(
          organization_id_or_slug :: String.t(),
          issue_id :: String.t(),
          opts :: keyword
        ) :: {:ok, Sentry.IssueDetailed.t()} | :error
  def retrieve_an_issue(organization_id_or_slug, issue_id, opts \\ []) do
    ...
    client.request(%{
      args: [organization_id_or_slug: organization_id_or_slug, issue_id: issue_id],
      call: {Sentry.Events, :retrieve_an_issue},
      url: "/api/0/organizations/#{organization_id_or_slug}/issues/#{issue_id}/",
      method: :get,
      response: [{200, {Sentry.IssueDetailed, :t}}, {403, :null}],
      opts: opts
    })
  end
  ...
  Returns details for given tag key related to an issue.
  """
  @spec retrieve_tag_details(
          organization_id_or_slug :: String.t(),
          issue_id :: String.t(),
          key :: String.t()
        ) :: {:ok, Sentry.Events.retrieve_tag_details_200_json_resp()} | :error
  @spec retrieve_tag_details(
          organization_id_or_slug :: String.t(),
          issue_id :: String.t(),
          key :: String.t(),
  ...
  def retrieve_tag_details(organization_id_or_slug, issue_id, key, opts \\ []) do
    ...
    client.request(%{
      args: [organization_id_or_slug: organization_id_or_slug, issue_id: issue_id, key: key],
      call: {Sentry.Events, :retrieve_tag_details},
      url: "/api/0/organizations/#{organization_id_or_slug}/issues/#{issue_id}/tags/#{key}/",
      method: :get,
      response: [{200, {Sentry.Events, :retrieve_tag_details_200_json_resp}}, {403, :null}],
      opts: opts
    })
  end
  ...
  """
  @spec retrieve_the_latest_event_for_an_issue(
          organization_id_or_slug :: String.t(),
          issue_id :: String.t()
        ) :: {:ok, Sentry.EventDetailed.t()} | :error
  @spec retrieve_the_latest_event_for_an_issue(
  ...
  def retrieve_the_latest_event_for_an_issue(organization_id_or_slug, issue_id, opts \\ []) do
    ...
    client.request(%{
      args: [organization_id_or_slug: organization_id_or_slug, issue_id: issue_id],
      call: {Sentry.Events, :retrieve_the_latest_event_for_an_issue},
  ...
  """
  @spec retrieve_the_oldest_event_for_an_issue(
          organization_id_or_slug :: String.t(),
          issue_id :: String.t()
        ) :: {:ok, Sentry.EventDetailed.t()} | :error
  @spec retrieve_the_oldest_event_for_an_issue(
  ...
  def retrieve_the_oldest_event_for_an_issue(organization_id_or_slug, issue_id, opts \\ []) do
    ...
    client.request(%{
      args: [organization_id_or_slug: organization_id_or_slug, issue_id: issue_id],
      call: {Sentry.Events, :retrieve_the_oldest_event_for_an_issue},
  ...
  **Content Types**: `application/json`
  """
  @spec update_an_issue(
          organization_id_or_slug :: String.t(),
          issue_id :: String.t(),
          body :: map
        ) :: {:ok, Sentry.IssueNoStats.t()} | :error
  @spec update_an_issue(
          organization_id_or_slug :: String.t(),
          issue_id :: String.t(),
          body :: map,
  ...
  def update_an_issue(organization_id_or_slug, issue_id, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {Sentry.Events, :update_an_issue},
      url: "/api/0/organizations/#{organization_id_or_slug}/issues/#{issue_id}/",
      body: body,
      method: :put,
      request: [{"application/json", :map}],
      response: [{200, {Sentry.IssueNoStats, :t}}, {403, :null}, {404, :null}],
      opts: opts
    })
  end
  ...
  def __fields__(:list_an_issue_s_hashes_200_json_resp) do
    [id: :string, latestEvent: {Sentry.Hash, :t}]
  end

  def __fields__(:retrieve_tag_details_200_json_resp) do
    [key: :string, totalValues: :integer]
  end
end
