defmodule Events do
  ...
  @spec bulk_mutate_a_list_of_issues(
          ...
          body :: map,
          opts :: keyword
        ) :: {:ok, Events.bulk_mutate_a_list_of_issues_200_json_resp()} | :error
  ...
  @spec list_a_tag_s_values_related_to_an_issue(
          ...
          key :: String.t(),
          opts :: keyword
        ) :: {:ok, [Events.list_a_tag_s_values_related_to_an_issue_200_json_resp()]} | :error
  ...
  @spec list_an_issue_s_hashes(
          ...
          issue_id :: String.t(),
          opts :: keyword
        ) :: {:ok, [Events.list_an_issue_s_hashes_200_json_resp()]} | :error
  ...
  @spec retrieve_tag_details(
          ...
          key :: String.t(),
          opts :: keyword
        ) :: {:ok, Events.retrieve_tag_details_200_json_resp()} | :error
