defmodule Integration do
  ...
  **Content Types**: `application/json`
  ...
  @spec create_an_external_issue(uuid :: String.t(), body :: map, opts :: keyword) ::
          {:ok, Integration.create_an_external_issue_200_json_resp()} | :error
  ...
  @type list_an_organization_s_integration_platform_installations_200_json_resp :: %{
          app:
            Integration.list_an_organization_s_integration_platform_installations_200_json_resp_app(),
          organization:
            Integration.list_an_organization_s_integration_platform_installations_200_json_resp_organization(),
          status: String.t(),
          uuid: String.t()
        }
  ...
  def __fields__(:list_an_organization_s_integration_platform_installations_200_json_resp_app) do
    [slug: {:string, :generic}, uuid: {:string, :generic}]
  end
