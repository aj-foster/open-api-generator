defmodule Mollie.EntityBalanceTransactionContextReturnedRefundCompensation do
  @moduledoc """
  Provides struct and type for a EntityBalanceTransactionContextReturnedRefundCompensation
  """
