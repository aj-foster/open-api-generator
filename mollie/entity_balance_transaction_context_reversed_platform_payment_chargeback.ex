defmodule Mollie.EntityBalanceTransactionContextReversedPlatformPaymentChargeback do
  @moduledoc """
  Provides struct and type for a EntityBalanceTransactionContextReversedPlatformPaymentChargeback
  """
