defmodule Mollie.SalesInvoiceResponse do
  ...
  def __fields__(:t) do
    [
      ...
      dueAt: {:union, [{:string, :generic}, :null]},
      emailDetails: {:union, [{Mollie.SalesInvoiceEmailDetails, :t}, :null]},
      id: {:string, :generic},
      invoiceNumber: {:union, [{:string, :generic}, :null]},
      issuedAt: {:union, [{:string, :generic}, :null]},
      lines: {:union, [[:map], :null]},
      mandateId: {:string, :generic},
      memo: {:union, [{:string, :generic}, :null]},
      ...
      profileId: {:union, [{:string, :generic}, :null]},
      recipient: {:union, [{Mollie.SalesInvoiceRecipientResponse, :t}, :null]},
      recipientIdentifier: {:string, :generic},
