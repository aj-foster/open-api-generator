defmodule Mollie.EntityBalanceTransactionContextReturnedPlatformPaymentRefund do
  @moduledoc """
  Provides struct and type for a EntityBalanceTransactionContextReturnedPlatformPaymentRefund
  """
  ...
  def __fields__(:t) do
    [
      ...
      refundDescription: {:string, :generic},
      refundId: {:string, :generic}
    ]
  end
end
