defmodule Mollie.EntityBalanceTransactionContextPlatformPaymentRefund do
  @moduledoc """
  Provides struct and type for a EntityBalanceTransactionContextPlatformPaymentRefund
  """
