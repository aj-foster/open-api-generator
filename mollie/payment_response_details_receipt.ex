defmodule Mollie.PaymentResponseDetailsReceipt do
  @moduledoc """
  Provides struct and type for a PaymentResponseDetailsReceipt
  """
  ...
  def __fields__(:t) do
    [
      applicationIdentifier: {:union, [{:string, :generic}, :null]},
      authorizationCode: {:union, [{:string, :generic}, :null]},
      cardReadMethod:
