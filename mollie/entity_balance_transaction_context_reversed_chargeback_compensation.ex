defmodule Mollie.EntityBalanceTransactionContextReversedChargebackCompensation do
  @moduledoc """
  Provides struct and type for a EntityBalanceTransactionContextReversedChargebackCompensation
  """
