defmodule Post.Crm.V3.Objects.Companies.Batch do
  @moduledoc """
  ...
  def archive_archive(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Post.Crm.V3.Objects.Companies.Batch, :archive_archive},
  ...
  def create_create(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Post.Crm.V3.Objects.Companies.Batch, :create_create},
  ...
  def read_read(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Post.Crm.V3.Objects.Companies.Batch, :read_read},
  ...
  def update_update(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {Post.Crm.V3.Objects.Companies.Batch, :update_update},
