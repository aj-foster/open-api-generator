defmodule GitHub.GlobalAdvisory do
  ...
  def __fields__(:t) do
    [
      ...
      cve_id: {:union, [:string, :null]},
      cvss: {:union, [{GitHub.GlobalAdvisoryCvss, :t}, :null]},
      cwes: {:union, [[:map], :null]},
      description: {:union, [:string, :null]},
      ghsa_id: :string,
      github_reviewed_at: {:union, [{:string, "date-time"}, :null]},
      html_url: {:string, "uri"},
      identifiers: {:union, [[:map], :null]},
      nvd_published_at: {:union, [{:string, "date-time"}, :null]},
      published_at: {:string, "date-time"},
      references: {:union, [[:string], :null]},
      ...
      withdrawn_at: {:union, [{:string, "date-time"}, :null]}
    ]
  end
end
