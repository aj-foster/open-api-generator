defmodule GitHub.PullRequest.HeadRepo do
  @moduledoc """
  Provides struct and types for a PullRequest.HeadRepo
  """
  use GitHub.Encoder

  @type minimal :: %__MODULE__{__info__: map, id: integer, name: String.t(), url: String.t()}
  ...
  @type t :: %__MODULE__{
          ...
          license: GitHub.PullRequest.HeadRepoLicense.t() | nil,
          ...
          owner: GitHub.PullRequest.HeadRepoOwner.t(),
          permissions: GitHub.PullRequest.HeadRepoPermissions.t() | nil,
          private: boolean,
          pulls_url: String.t(),
  ...
  def __fields__(:t) do
    [
      ...
      license: {:union, [{GitHub.PullRequest.HeadRepoLicense, :t}, :null]},
      ...
      open_issues_count: :integer,
      owner: {GitHub.PullRequest.HeadRepoOwner, :t},
      permissions: {GitHub.PullRequest.HeadRepoPermissions, :t},
      private: :boolean,
      pulls_url: :string,
