defmodule GitHub.Meta do
  ...
  **Note:** This endpoint returns both IPv4 and IPv6 addresses. However, not all features support IPv6. You should refer to the specific documentation for each feature to determine if IPv6 is supported.
  ...
  """
  @spec get(opts :: keyword) :: {:ok, GitHub.ApiOverview.t()} | {:error, GitHub.Error.t()}
  def get(opts \\ []) do
  ...
  """
  @spec get_all_versions(opts :: keyword) :: {:ok, [Date.t()]} | {:error, GitHub.Error.t()}
  ...
  """
  @spec get_octocat(opts :: keyword) :: {:ok, String.t()} | {:error, GitHub.Error.t()}
  ...
  """
  @spec get_zen(opts :: keyword) :: {:ok, String.t()} | {:error, GitHub.Error.t()}
  def get_zen(opts \\ []) do
    client = opts[:client] || @default_client
  ...
  """
  @spec root(opts :: keyword) :: {:ok, GitHub.Root.t()} | {:error, GitHub.Error.t()}
  def root(opts \\ []) do
    client = opts[:client] || @default_client
