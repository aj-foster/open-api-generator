defmodule GitHub.Activity do
  ...
  """
  @spec check_repo_is_starred_by_authenticated_user(
          owner :: String.t(),
          repo :: String.t(),
          opts :: keyword
  ...
  """
  @spec delete_repo_subscription(owner :: String.t(), repo :: String.t(), opts :: keyword) ::
          :ok | {:error, GitHub.Error.t()}
  ...
  """
  @spec delete_thread_subscription(thread_id :: integer, opts :: keyword) ::
          :ok | {:error, GitHub.Error.t()}
  ...
  **Note**: Private feeds are only returned when [authenticating via Basic Auth](https://docs.github.com/rest/overview/other-authentication-methods#basic-authentication) since current feed URIs use the older, non revocable auth tokens.
  ...
  """
  @spec get_feeds(opts :: keyword) :: {:ok, GitHub.Feed.t()} | {:error, GitHub.Error.t()}
  ...
  """
  @spec get_repo_subscription(owner :: String.t(), repo :: String.t(), opts :: keyword) ::
  ...
  """
  @spec get_thread(thread_id :: integer, opts :: keyword) ::
  ...
  """
  @spec get_thread_subscription_for_authenticated_user(thread_id :: integer, opts :: keyword) ::
  ...
  """
  @spec list_events_for_authenticated_user(username :: String.t(), opts :: keyword) ::
  ...
  """
  @spec list_notifications_for_authenticated_user(opts :: keyword) ::
          {:ok, [GitHub.Thread.t()]} | {:error, GitHub.Error.t()}
  ...
  """
  @spec list_org_events_for_authenticated_user(
          username :: String.t(),
          org :: String.t(),
          opts :: keyword
        ) :: {:ok, [GitHub.Event.t()]} | {:error, GitHub.Error.t()}
  ...
  """
  @spec list_public_events(opts :: keyword) ::
          {:ok, [GitHub.Event.t()]} | {:error, GitHub.Error.t()}
  ...
  """
  @spec list_public_events_for_repo_network(
          owner :: String.t(),
          repo :: String.t(),
          opts :: keyword
        ) :: {:ok, [GitHub.Event.t()]} | {:error, GitHub.Error.t()}
  ...
  """
  @spec list_public_events_for_user(username :: String.t(), opts :: keyword) ::
          {:ok, [GitHub.Event.t()]} | {:error, GitHub.Error.t()}
  ...
  """
  @spec list_public_org_events(org :: String.t(), opts :: keyword) ::
          {:ok, [GitHub.Event.t()]} | {:error, GitHub.Error.t()}
  ...
  """
  @spec list_received_events_for_user(username :: String.t(), opts :: keyword) ::
          {:ok, [GitHub.Event.t()]} | {:error, GitHub.Error.t()}
  ...
  """
  @spec list_received_public_events_for_user(username :: String.t(), opts :: keyword) ::
          {:ok, [GitHub.Event.t()]} | {:error, GitHub.Error.t()}
  ...
  **Note**: This API is not built to serve real-time use cases. Depending on the time of day, event latency can be anywhere from 30s to 6h.
  ...
  """
  @spec list_repo_events(owner :: String.t(), repo :: String.t(), opts :: keyword) ::
          {:ok, [GitHub.Event.t()]} | {:error, GitHub.Error.t()}
  ...
  """
  @spec list_repos_starred_by_authenticated_user(opts :: keyword) ::
  ...
  """
  @spec list_repos_starred_by_user(username :: String.t(), opts :: keyword) ::
          {:ok, [GitHub.Repository.t()] | [GitHub.StarredRepository.t()]}
          | {:error, GitHub.Error.t()}
  ...
  """
  @spec list_repos_watched_by_user(username :: String.t(), opts :: keyword) ::
  ...
  """
  @spec list_stargazers_for_repo(owner :: String.t(), repo :: String.t(), opts :: keyword) ::
  ...
  """
  @spec list_watched_repos_for_authenticated_user(opts :: keyword) ::
          {:ok, [GitHub.Repository.minimal()]} | {:error, GitHub.Error.t()}
  ...
  """
  @spec list_watchers_for_repo(owner :: String.t(), repo :: String.t(), opts :: keyword) ::
  ...
  **Content Types**: `application/json`
  ...
  """
  @spec mark_notifications_as_read(body :: map, opts :: keyword) ::
          {:ok, GitHub.Activity.mark_notifications_as_read_202_json_resp()}
          | {:error, GitHub.Error.t()}
  ...
  **Content Types**: `application/json`
  ...
  """
  @spec mark_repo_notifications_as_read(
          owner :: String.t(),
          repo :: String.t(),
          body :: map,
          opts :: keyword
        ) ::
          {:ok, GitHub.Activity.mark_repo_notifications_as_read_202_json_resp()}
          | {:error, GitHub.Error.t()}
  ...
  """
  @spec mark_thread_as_done(thread_id :: integer, opts :: keyword) ::
          :ok | {:error, GitHub.Error.t()}
  ...
  """
  @spec mark_thread_as_read(thread_id :: integer, opts :: keyword) ::
          :ok | {:error, GitHub.Error.t()}
  ...
  **Content Types**: `application/json`
  ...
  """
  @spec set_thread_subscription(thread_id :: integer, body :: map, opts :: keyword) ::
          {:ok, GitHub.ThreadSubscription.t()} | {:error, GitHub.Error.t()}
  ...
  """
  @spec star_repo_for_authenticated_user(owner :: String.t(), repo :: String.t(), opts :: keyword) ::
          :ok | {:error, GitHub.Error.t()}
  ...
  """
  @spec unstar_repo_for_authenticated_user(
          owner :: String.t(),
          repo :: String.t(),
          opts :: keyword
        ) :: :ok | {:error, GitHub.Error.t()}
