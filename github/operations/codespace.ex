defmodule GitHub.Codespace do
  @moduledoc """
  Provides API endpoints related to codespace
  """
  use GitHub.Encoder
  ...
  def add_repository_for_secret_for_authenticated_user(secret_name, repository_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHub.Codespace, :add_repository_for_secret_for_authenticated_user},
  ...
  """
  @spec add_selected_repo_to_org_secret(
          org :: String.t(),
          secret_name :: String.t(),
          repository_id :: integer,
          opts :: keyword
  ...
  def add_selected_repo_to_org_secret(org, secret_name, repository_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHub.Codespace, :add_selected_repo_to_org_secret},
  ...
  """
  @spec check_permissions_for_devcontainer(
          owner :: String.t(),
          repo :: String.t(),
          opts :: keyword
        ) ::
  ...
  def check_permissions_for_devcontainer(owner, repo, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHub.Codespace, :check_permissions_for_devcontainer},
  ...
  """
  @spec codespace_machines_for_authenticated_user(codespace_name :: String.t(), opts :: keyword) ::
  ...
  def codespace_machines_for_authenticated_user(codespace_name, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHub.Codespace, :codespace_machines_for_authenticated_user},
  ...
  **Content Types**: `application/json`
  ...
  def create_for_authenticated_user(body, opts \\ []) do
    ...
    client.request(%{
      args: [body: body],
      call: {GitHub.Codespace, :create_for_authenticated_user},
      url: "/user/codespaces",
      body: body,
      method: :post,
  ...
  **Content Types**: `application/json`
  ...
  def create_or_update_org_secret(org, secret_name, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHub.Codespace, :create_or_update_org_secret},
  ...
  **Content Types**: `application/json`
  ...
  def create_or_update_repo_secret(owner, repo, secret_name, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHub.Codespace, :create_or_update_repo_secret},
  ...
  **Content Types**: `application/json`
  ...
  def create_or_update_secret_for_authenticated_user(secret_name, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHub.Codespace, :create_or_update_secret_for_authenticated_user},
  ...
  **Content Types**: `application/json`
  ...
  def create_with_pr_for_authenticated_user(owner, repo, pull_number, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHub.Codespace, :create_with_pr_for_authenticated_user},
  ...
  **Content Types**: `application/json`
  ...
  def create_with_repo_for_authenticated_user(owner, repo, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHub.Codespace, :create_with_repo_for_authenticated_user},
  ...
  **Content Types**: `application/json`
  ...
  """
  @spec delete_codespaces_access_users(org :: String.t(), body :: map, opts :: keyword) ::
          :ok | {:error, GitHub.Error.t()}
  def delete_codespaces_access_users(org, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHub.Codespace, :delete_codespaces_access_users},
  ...
  """
  @spec delete_for_authenticated_user(codespace_name :: String.t(), opts :: keyword) ::
  ...
  def delete_for_authenticated_user(codespace_name, opts \\ []) do
    ...
    client.request(%{
      args: [codespace_name: codespace_name],
      call: {GitHub.Codespace, :delete_for_authenticated_user},
  ...
  """
  @spec delete_from_organization(
          org :: String.t(),
          username :: String.t(),
          codespace_name :: String.t(),
          opts :: keyword
        ) :: {:ok, map} | {:error, GitHub.Error.t()}
  def delete_from_organization(org, username, codespace_name, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHub.Codespace, :delete_from_organization},
  ...
  """
  @spec delete_org_secret(org :: String.t(), secret_name :: String.t(), opts :: keyword) ::
          :ok | {:error, GitHub.Error.t()}
  def delete_org_secret(org, secret_name, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHub.Codespace, :delete_org_secret},
      url: "/orgs/#{org}/codespaces/secrets/#{secret_name}",
      method: :delete,
  ...
  def delete_repo_secret(owner, repo, secret_name, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHub.Codespace, :delete_repo_secret},
      url: "/repos/#{owner}/#{repo}/codespaces/secrets/#{secret_name}",
      method: :delete,
      response: [{204, :null}],
      opts: opts
  ...
  """
  @spec delete_secret_for_authenticated_user(secret_name :: String.t(), opts :: keyword) ::
          :ok | {:error, GitHub.Error.t()}
  def delete_secret_for_authenticated_user(secret_name, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHub.Codespace, :delete_secret_for_authenticated_user},
      url: "/user/codespaces/secrets/#{secret_name}",
      method: :delete,
      response: [{204, :null}],
      opts: opts
  ...
  """
  @spec export_for_authenticated_user(codespace_name :: String.t(), opts :: keyword) ::
  ...
  def export_for_authenticated_user(codespace_name, opts \\ []) do
    ...
    client.request(%{
      args: [codespace_name: codespace_name],
      call: {GitHub.Codespace, :export_for_authenticated_user},
  ...
  """
  @spec get_codespaces_for_user_in_org(org :: String.t(), username :: String.t(), opts :: keyword) ::
  ...
  def get_codespaces_for_user_in_org(org, username, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHub.Codespace, :get_codespaces_for_user_in_org},
  ...
  """
  @spec get_export_details_for_authenticated_user(
          codespace_name :: String.t(),
          export_id :: String.t(),
          opts :: keyword
        ) :: {:ok, GitHub.Codespace.ExportDetails.t()} | {:error, GitHub.Error.t()}
  def get_export_details_for_authenticated_user(codespace_name, export_id, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHub.Codespace, :get_export_details_for_authenticated_user},
  ...
  """
  @spec get_for_authenticated_user(codespace_name :: String.t(), opts :: keyword) ::
          {:ok, GitHub.Codespace.t()} | {:error, GitHub.Error.t()}
  def get_for_authenticated_user(codespace_name, opts \\ []) do
    ...
    client.request(%{
      args: [codespace_name: codespace_name],
      call: {GitHub.Codespace, :get_for_authenticated_user},
      url: "/user/codespaces/#{codespace_name}",
      method: :get,
      response: [
  ...
  """
  @spec get_org_public_key(org :: String.t(), opts :: keyword) ::
  ...
  def get_org_public_key(org, opts \\ []) do
    ...
    client.request(%{
      args: [org: org],
      call: {GitHub.Codespace, :get_org_public_key},
  ...
  """
  @spec get_org_secret(org :: String.t(), secret_name :: String.t(), opts :: keyword) ::
  ...
  def get_org_secret(org, secret_name, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, secret_name: secret_name],
      call: {GitHub.Codespace, :get_org_secret},
      url: "/orgs/#{org}/codespaces/secrets/#{secret_name}",
      method: :get,
  ...
  """
  @spec get_public_key_for_authenticated_user(opts :: keyword) ::
  ...
  def get_public_key_for_authenticated_user(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {GitHub.Codespace, :get_public_key_for_authenticated_user},
  ...
  """
  @spec get_repo_public_key(owner :: String.t(), repo :: String.t(), opts :: keyword) ::
          {:ok, GitHub.Codespace.PublicKey.t()} | {:error, GitHub.Error.t()}
  def get_repo_public_key(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHub.Codespace, :get_repo_public_key},
  ...
  def get_repo_secret(owner, repo, secret_name, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo, secret_name: secret_name],
      call: {GitHub.Codespace, :get_repo_secret},
      url: "/repos/#{owner}/#{repo}/codespaces/secrets/#{secret_name}",
      method: :get,
  ...
  """
  @spec get_secret_for_authenticated_user(secret_name :: String.t(), opts :: keyword) ::
  ...
  def get_secret_for_authenticated_user(secret_name, opts \\ []) do
    ...
    client.request(%{
      args: [secret_name: secret_name],
      call: {GitHub.Codespace, :get_secret_for_authenticated_user},
      url: "/user/codespaces/secrets/#{secret_name}",
      method: :get,
  ...
  @type list_devcontainers_in_repository_for_authenticated_user_200_json_resp :: %{
          __info__: map,
          devcontainers: [
            GitHub.Codespace.list_devcontainers_in_repository_for_authenticated_user_200_json_resp_devcontainers()
          ],
          total_count: integer
        }

  @type list_devcontainers_in_repository_for_authenticated_user_200_json_resp_devcontainers :: %{
          __info__: map,
  ...
  def list_devcontainers_in_repository_for_authenticated_user(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHub.Codespace, :list_devcontainers_in_repository_for_authenticated_user},
  ...
  def list_for_authenticated_user(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {GitHub.Codespace, :list_for_authenticated_user},
      url: "/user/codespaces",
      method: :get,
      query: query,
      response: [
  ...
  """
  @spec list_in_organization(org :: String.t(), opts :: keyword) ::
  ...
  def list_in_organization(org, opts \\ []) do
    ...
    client.request(%{
      args: [org: org],
      call: {GitHub.Codespace, :list_in_organization},
  ...
  """
  @spec list_in_repository_for_authenticated_user(
          owner :: String.t(),
          repo :: String.t(),
          opts :: keyword
        ) ::
  ...
  def list_in_repository_for_authenticated_user(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHub.Codespace, :list_in_repository_for_authenticated_user},
      url: "/repos/#{owner}/#{repo}/codespaces",
      method: :get,
      query: query,
      response: [
  ...
  """
  @spec list_org_secrets(org :: String.t(), opts :: keyword) ::
  ...
  def list_org_secrets(org, opts \\ []) do
    ...
    client.request(%{
      args: [org: org],
      call: {GitHub.Codespace, :list_org_secrets},
  ...
  """
  @spec list_repo_secrets(owner :: String.t(), repo :: String.t(), opts :: keyword) ::
  ...
  def list_repo_secrets(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHub.Codespace, :list_repo_secrets},
  ...
  def list_repositories_for_secret_for_authenticated_user(secret_name, opts \\ []) do
    ...
    client.request(%{
      args: [secret_name: secret_name],
      call: {GitHub.Codespace, :list_repositories_for_secret_for_authenticated_user},
  ...
  """
  @spec list_secrets_for_authenticated_user(opts :: keyword) ::
  ...
  def list_secrets_for_authenticated_user(opts \\ []) do
    ...
    client.request(%{
      args: [],
      call: {GitHub.Codespace, :list_secrets_for_authenticated_user},
  ...
  """
  @spec list_selected_repos_for_org_secret(
          org :: String.t(),
          secret_name :: String.t(),
          opts :: keyword
        ) ::
  ...
  def list_selected_repos_for_org_secret(org, secret_name, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, secret_name: secret_name],
      call: {GitHub.Codespace, :list_selected_repos_for_org_secret},
  ...
  @type pre_flight_with_repo_for_authenticated_user_200_json_resp :: %{
          ...
          defaults:
            GitHub.Codespace.pre_flight_with_repo_for_authenticated_user_200_json_resp_defaults()
            | nil
        }

  @type pre_flight_with_repo_for_authenticated_user_200_json_resp_defaults :: %{
          __info__: map,
  ...
  """
  @spec pre_flight_with_repo_for_authenticated_user(
          owner :: String.t(),
          repo :: String.t(),
          opts :: keyword
        ) ::
  ...
  def pre_flight_with_repo_for_authenticated_user(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHub.Codespace, :pre_flight_with_repo_for_authenticated_user},
  ...
  **Content Types**: `application/json`
  ...
  """
  @spec publish_for_authenticated_user(codespace_name :: String.t(), body :: map, opts :: keyword) ::
  ...
  def publish_for_authenticated_user(codespace_name, body, opts \\ []) do
    ...
    client.request(%{
      ...
      call: {GitHub.Codespace, :publish_for_authenticated_user},
  ...
  def remove_repository_for_secret_for_authenticated_user(secret_name, repository_id, opts \\ []) do
    ...
    client.request(%{
      args: [secret_name: secret_name, repository_id: repository_id],
      call: {GitHub.Codespace, :remove_repository_for_secret_for_authenticated_user},
      url: "/user/codespaces/secrets/#{secret_name}/repositories/#{repository_id}",
      method: :delete,
      response: [
        {204, :null},
  ...
  def remove_selected_repo_from_org_secret(org, secret_name, repository_id, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, secret_name: secret_name, repository_id: repository_id],
      call: {GitHub.Codespace, :remove_selected_repo_from_org_secret},
      url: "/orgs/#{org}/codespaces/secrets/#{secret_name}/repositories/#{repository_id}",
      method: :delete,
      response: [
        {204, :null},
  ...
  """
  @spec repo_machines_for_authenticated_user(
          owner :: String.t(),
          repo :: String.t(),
          opts :: keyword
        ) ::
  ...
  def repo_machines_for_authenticated_user(owner, repo, opts \\ []) do
    ...
    client.request(%{
      args: [owner: owner, repo: repo],
      call: {GitHub.Codespace, :repo_machines_for_authenticated_user},
  ...
  **Content Types**: `application/json`
  ...
  """
  @spec set_codespaces_access(org :: String.t(), body :: map, opts :: keyword) ::
          :ok | {:error, GitHub.Error.t()}
  def set_codespaces_access(org, body, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, body: body],
      call: {GitHub.Codespace, :set_codespaces_access},
  ...
  **Content Types**: `application/json`
  ...
  """
  @spec set_codespaces_access_users(org :: String.t(), body :: map, opts :: keyword) ::
          :ok | {:error, GitHub.Error.t()}
  def set_codespaces_access_users(org, body, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, body: body],
      call: {GitHub.Codespace, :set_codespaces_access_users},
      url: "/orgs/#{org}/codespaces/access/selected_users",
      body: body,
      method: :post,
      request: [{"application/json", :map}],
  ...
  **Content Types**: `application/json`
  ...
  def set_repositories_for_secret_for_authenticated_user(secret_name, body, opts \\ []) do
    ...
    client.request(%{
      args: [secret_name: secret_name, body: body],
      call: {GitHub.Codespace, :set_repositories_for_secret_for_authenticated_user},
      url: "/user/codespaces/secrets/#{secret_name}/repositories",
      body: body,
      method: :put,
      request: [{"application/json", :map}],
  ...
  **Content Types**: `application/json`
  ...
  def set_selected_repos_for_org_secret(org, secret_name, body, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, secret_name: secret_name, body: body],
      call: {GitHub.Codespace, :set_selected_repos_for_org_secret},
      url: "/orgs/#{org}/codespaces/secrets/#{secret_name}/repositories",
      body: body,
      method: :put,
      request: [{"application/json", :map}],
  ...
  """
  @spec start_for_authenticated_user(codespace_name :: String.t(), opts :: keyword) ::
          {:ok, GitHub.Codespace.t()} | {:error, GitHub.Error.t()}
  def start_for_authenticated_user(codespace_name, opts \\ []) do
    ...
    client.request(%{
      args: [codespace_name: codespace_name],
      call: {GitHub.Codespace, :start_for_authenticated_user},
  ...
  """
  @spec stop_for_authenticated_user(codespace_name :: String.t(), opts :: keyword) ::
          {:ok, GitHub.Codespace.t()} | {:error, GitHub.Error.t()}
  def stop_for_authenticated_user(codespace_name, opts \\ []) do
    ...
    client.request(%{
      args: [codespace_name: codespace_name],
      call: {GitHub.Codespace, :stop_for_authenticated_user},
  ...
  def stop_in_organization(org, username, codespace_name, opts \\ []) do
    ...
    client.request(%{
      args: [org: org, username: username, codespace_name: codespace_name],
      call: {GitHub.Codespace, :stop_in_organization},
  ...
  **Content Types**: `application/json`
  ...
  """
  @spec update_for_authenticated_user(codespace_name :: String.t(), body :: map, opts :: keyword) ::
          {:ok, GitHub.Codespace.t()} | {:error, GitHub.Error.t()}
  def update_for_authenticated_user(codespace_name, body, opts \\ []) do
    ...
    client.request(%{
      args: [codespace_name: codespace_name, body: body],
      call: {GitHub.Codespace, :update_for_authenticated_user},
      url: "/user/codespaces/#{codespace_name}",
      body: body,
      method: :patch,
      request: [{"application/json", :map}],
  ...
  def __fields__(:list_devcontainers_in_repository_for_authenticated_user_200_json_resp) do
    [
      devcontainers: [
        {GitHub.Codespace,
         :list_devcontainers_in_repository_for_authenticated_user_200_json_resp_devcontainers}
      ],
      total_count: :integer
    ]
  end
  ...
  def __fields__(
    ...
    [display_name: :string, name: :string, path: :string]
  end
  ...
  def __fields__(:pre_flight_with_repo_for_authenticated_user_200_json_resp_defaults) do
    [devcontainer_path: {:union, [:string, :null]}, location: :string]
  end
  ...
  def __fields__(:t) do
    [
      ...
      devcontainer_path: {:union, [:string, :null]},
      display_name: {:union, [:string, :null]},
      environment_id: {:union, [:string, :null]},
      git_status: {GitHub.Codespace.GitStatus, :t},
      id: :integer,
      idle_timeout_minutes: {:union, [:integer, :null]},
      idle_timeout_notice: {:union, [:string, :null]},
      last_known_stop_notice: {:union, [:string, :null]},
      ...
      pending_operation_disabled_reason: {:union, [:string, :null]},
      prebuild: {:union, [:boolean, :null]},
      publish_url: {:union, [{:string, "uri"}, :null]},
      pulls_url: {:union, [{:string, "uri"}, :null]},
      recent_folders: [:string],
      repository: {GitHub.Repository, :minimal},
      retention_expires_at: {:union, [{:string, "date-time"}, :null]},
