defmodule GitHub.Git do
  ...
  **Content Types**: `application/json`
  ...
  """
  @spec create_blob(owner :: String.t(), repo :: String.t(), body :: map, opts :: keyword) ::
  ...
  **Content Types**: `application/json`
  ...
  """
  @spec create_commit(owner :: String.t(), repo :: String.t(), body :: map, opts :: keyword) ::
  ...
  **Content Types**: `application/json`
  ...
  """
  @spec create_ref(owner :: String.t(), repo :: String.t(), body :: map, opts :: keyword) ::
  ...
  **Content Types**: `application/json`
  ...
  """
  @spec create_tag(owner :: String.t(), repo :: String.t(), body :: map, opts :: keyword) ::
  ...
  **Content Types**: `application/json`
  ...
  """
  @spec create_tree(owner :: String.t(), repo :: String.t(), body :: map, opts :: keyword) ::
  ...
  """
  @spec delete_ref(owner :: String.t(), repo :: String.t(), ref :: String.t(), opts :: keyword) ::
  ...
  **Note** This endpoint supports blobs up to 100 megabytes in size.
  ...
  """
  @spec get_blob(owner :: String.t(), repo :: String.t(), file_sha :: String.t(), opts :: keyword) ::
  ...
  **Note:** You need to explicitly [request a pull request](https://docs.github.com/rest/pulls/pulls#get-a-pull-request) to trigger a test merge commit, which checks the mergeability of pull requests. For more information, see "[Checking mergeability of pull requests](https://docs.github.com/rest/guides/getting-started-with-the-git-database-api#checking-mergeability-of-pull-requests)".
  ...
  """
  @spec get_ref(owner :: String.t(), repo :: String.t(), ref :: String.t(), opts :: keyword) ::
          {:ok, GitHub.Git.Ref.t()} | {:error, GitHub.Error.t()}
  ...
  **Signature verification object**
  ...
  """
  @spec get_tag(owner :: String.t(), repo :: String.t(), tag_sha :: String.t(), opts :: keyword) ::
          {:ok, GitHub.Git.Tag.t()} | {:error, GitHub.Error.t()}
  ...
  **Note**: The limit for the `tree` array is 100,000 entries with a maximum size of 7 MB when using the `recursive` parameter.
  ...
  """
  @spec get_tree(owner :: String.t(), repo :: String.t(), tree_sha :: String.t(), opts :: keyword) ::
          {:ok, GitHub.Git.Tree.t()} | {:error, GitHub.Error.t()}
