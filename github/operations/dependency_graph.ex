defmodule GitHub.DependencyGraph do
  ...
  **Content Types**: `application/json`
  ...
  @spec create_repository_snapshot(
          owner :: String.t(),
          repo :: String.t(),
          body :: GitHub.Snapshot.t(),
          opts :: keyword
        ) ::
          {:ok, GitHub.DependencyGraph.create_repository_snapshot_201_json_resp()}
  ...
  """
  @spec export_sbom(owner :: String.t(), repo :: String.t(), opts :: keyword) ::
  ...
  def __fields__(:create_repository_snapshot_201_json_resp) do
    [created_at: :string, id: :integer, message: :string, result: :string]
  end
end
