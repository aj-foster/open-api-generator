defmodule GitHub.Dependabot do
  ...
  **Content Types**: `application/json`
  ...
  """
  @spec list_alerts_for_enterprise(enterprise :: String.t(), opts :: keyword) ::
  ...
  """
  @spec list_alerts_for_org(org :: String.t(), opts :: keyword) ::
          {:ok, [GitHub.Dependabot.Alert.WithRepository.t()]} | {:error, GitHub.Error.t()}
  ...
  """
  @spec list_alerts_for_repo(owner :: String.t(), repo :: String.t(), opts :: keyword) ::
          {:ok, [GitHub.Dependabot.Alert.t()]} | {:error, GitHub.Error.t()}
  ...
  @spec list_org_secrets(org :: String.t(), opts :: keyword) ::
          {:ok, GitHub.Dependabot.list_org_secrets_200_json_resp()} | {:error, GitHub.Error.t()}
  ...
  @spec list_repo_secrets(owner :: String.t(), repo :: String.t(), opts :: keyword) ::
          {:ok, GitHub.Dependabot.list_repo_secrets_200_json_resp()} | {:error, GitHub.Error.t()}
  ...
  @spec list_selected_repos_for_org_secret(
          ...
          {:ok, GitHub.Dependabot.list_selected_repos_for_org_secret_200_json_resp()}
