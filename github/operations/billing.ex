defmodule GitHub.Billing do
  ...
  """
  @spec get_github_actions_billing_org(org :: String.t(), opts :: keyword) ::
  ...
  """
  @spec get_github_actions_billing_user(username :: String.t(), opts :: keyword) ::
          {:ok, GitHub.Actions.BillingUsage.t()} | {:error, GitHub.Error.t()}
  ...
  """
  @spec get_github_packages_billing_org(org :: String.t(), opts :: keyword) ::
  ...
  """
  @spec get_github_packages_billing_user(username :: String.t(), opts :: keyword) ::
          {:ok, GitHub.PackagesBillingUsage.t()} | {:error, GitHub.Error.t()}
  ...
  """
  @spec get_shared_storage_billing_org(org :: String.t(), opts :: keyword) ::
  ...
  """
  @spec get_shared_storage_billing_user(username :: String.t(), opts :: keyword) ::
          {:ok, GitHub.CombinedBillingUsage.t()} | {:error, GitHub.Error.t()}
