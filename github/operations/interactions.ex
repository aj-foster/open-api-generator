defmodule GitHub.Interactions do
  ...
  """
  @spec get_restrictions_for_authenticated_user(opts :: keyword) ::
          {:ok,
  ...
  """
  @spec get_restrictions_for_org(org :: String.t(), opts :: keyword) ::
          {:ok,
           GitHub.Interaction.Limit.Response.t()
  ...
  """
  @spec get_restrictions_for_repo(owner :: String.t(), repo :: String.t(), opts :: keyword) ::
          {:ok,
           GitHub.Interaction.Limit.Response.t()
  ...
  """
  @spec remove_restrictions_for_authenticated_user(opts :: keyword) ::
  ...
  """
  @spec remove_restrictions_for_org(org :: String.t(), opts :: keyword) ::
          :ok | {:error, GitHub.Error.t()}
  ...
  """
  @spec remove_restrictions_for_repo(owner :: String.t(), repo :: String.t(), opts :: keyword) ::
          :ok | {:error, GitHub.Error.t()}
  ...
  **Content Types**: `application/json`
  ...
  @spec set_restrictions_for_authenticated_user(
          body :: GitHub.Interaction.Limit.t(),
          opts :: keyword
