defmodule GitHub.Classroom do
  ...
  """
  @spec get_a_classroom(classroom_id :: integer, opts :: keyword) ::
  ...
  """
  @spec get_an_assignment(assignment_id :: integer, opts :: keyword) ::
  ...
  """
  @spec get_assignment_grades(assignment_id :: integer, opts :: keyword) ::
  ...
  """
  @spec list_accepted_assigments_for_an_assignment(assignment_id :: integer, opts :: keyword) ::
  ...
  """
  @spec list_assignments_for_a_classroom(classroom_id :: integer, opts :: keyword) ::
  ...
  """
  @spec list_classrooms(opts :: keyword) ::
  ...
  def __fields__(:simple) do
    [archived: :boolean, id: :integer, name: :string, url: :string]
  end
