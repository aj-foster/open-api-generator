defmodule Spotify.ChapterObject do
  @moduledoc """
  Provides struct and type for a ChapterObject
  """

  @type t :: %__MODULE__{
          audio_preview_url: String.t() | nil,
          audiobook: Spotify.ChapterObjectAudiobook.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      audiobook: {Spotify.ChapterObjectAudiobook, :t},
