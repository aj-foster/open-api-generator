defmodule Spotify.Player do
  ...
  """
  @spec add_to_queue(opts :: keyword) ::
          :ok
          | {:error,
  ...
  """
  @spec get_a_users_available_devices(opts :: keyword) ::
  ...
  """
  @spec get_information_about_the_users_current_playback(opts :: keyword) ::
  ...
  """
  @spec get_recently_played(opts :: keyword) ::
  ...
  """
  @spec get_the_users_currently_playing_track(opts :: keyword) ::
          {:ok, Spotify.CurrentlyPlayingContextObject.t()}
          | {:error,
             Spotify.Forbidden.json_resp()
             | Spotify.TooManyRequests.json_resp()
  ...
  """
  @spec pause_a_users_playback(opts :: keyword) ::
          :ok
          | {:error,
             Spotify.Forbidden.json_resp()
             | Spotify.TooManyRequests.json_resp()
  ...
  """
  @spec seek_to_position_in_currently_playing_track(opts :: keyword) ::
          :ok
          | {:error,
             Spotify.Forbidden.json_resp()
             | Spotify.TooManyRequests.json_resp()
  ...
  """
  @spec set_repeat_mode_on_users_playback(opts :: keyword) ::
          :ok
          | {:error,
             Spotify.Forbidden.json_resp()
             | Spotify.TooManyRequests.json_resp()
  ...
  """
  @spec set_volume_for_users_playback(opts :: keyword) ::
          :ok
          | {:error,
             Spotify.Forbidden.json_resp()
             | Spotify.TooManyRequests.json_resp()
  ...
  """
  @spec skip_users_playback_to_next_track(opts :: keyword) ::
          :ok
          | {:error,
             Spotify.Forbidden.json_resp()
             | Spotify.TooManyRequests.json_resp()
  ...
  """
  @spec skip_users_playback_to_previous_track(opts :: keyword) ::
          :ok
          | {:error,
             Spotify.Forbidden.json_resp()
             | Spotify.TooManyRequests.json_resp()
  ...
  **Content Types**: `application/json`
  """
  @spec start_a_users_playback(body :: map, opts :: keyword) ::
          :ok
          | {:error,
             Spotify.Forbidden.json_resp()
             | Spotify.TooManyRequests.json_resp()
  ...
  """
  @spec toggle_shuffle_for_users_playback(opts :: keyword) ::
          :ok
          | {:error,
             Spotify.Forbidden.json_resp()
             | Spotify.TooManyRequests.json_resp()
  ...
  **Content Types**: `application/json`
  """
  @spec transfer_a_users_playback(body :: map, opts :: keyword) ::
          :ok
          | {:error,
             Spotify.Forbidden.json_resp()
             | Spotify.TooManyRequests.json_resp()
