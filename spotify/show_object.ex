defmodule Spotify.ShowObject do
  @moduledoc """
  Provides struct and type for a ShowObject
  """
  ...
  @type t :: %__MODULE__{
          ...
          episodes: Spotify.ShowObjectEpisodes.t() | nil,
  ...
  def __fields__(:t) do
    [
      ...
      description: :string,
      episodes: {Spotify.ShowObjectEpisodes, :t},
      explicit: :boolean,
      external_urls: :map,
      href: :string,
