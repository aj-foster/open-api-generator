defmodule Tracks do
  ...
  **Content Types**: `application/json`
  ...
  """
  @spec get_an_albums_tracks(id :: String.t(), opts :: keyword) ::
  ...
  """
  @spec get_an_artists_top_tracks(id :: String.t(), opts :: keyword) ::
  ...
  """
  @spec get_audio_analysis(id :: String.t(), opts :: keyword) ::
  ...
  """
  @spec get_audio_features(id :: String.t(), opts :: keyword) ::
  ...
  """
  @spec get_recommendations(opts :: keyword) ::
  ...
  """
  @spec get_several_audio_features(opts :: keyword) ::
  ...
  """
  @spec get_several_tracks(opts :: keyword) ::
          {:ok, ManyTracks.json_resp()}
          | {:error,
             Forbidden.json_resp() | TooManyRequests.json_resp() | Unauthorized.json_resp()}
  ...
  """
  @spec get_track(id :: String.t(), opts :: keyword) ::
          {:ok, TrackObject.t()}
          | {:error,
             Forbidden.json_resp() | TooManyRequests.json_resp() | Unauthorized.json_resp()}
