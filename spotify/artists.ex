defmodule Artists do
  ...
  **Content Types**: `application/json`
  ...
  """
  @spec get_an_artist(id :: String.t(), opts :: keyword) ::
          {:ok, ArtistObject.t()}
          | {:error,
             Forbidden.json_resp() | TooManyRequests.json_resp() | Unauthorized.json_resp()}
  ...
  """
  @spec get_an_artists_albums(id :: String.t(), opts :: keyword) ::
  ...
  """
  @spec get_an_artists_related_artists(id :: String.t(), opts :: keyword) ::
  ...
  """
  @spec get_multiple_artists(opts :: keyword) ::
          {:ok, ManyArtists.json_resp()}
          | {:error,
             Forbidden.json_resp() | TooManyRequests.json_resp() | Unauthorized.json_resp()}
