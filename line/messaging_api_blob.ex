defmodule Line.MessagingApiBlob do
  ...
  """
  @spec get_message_content(messageId :: String.t(), opts :: keyword) ::
          {:ok, String.t()} | :error
  ...
  """
  @spec get_rich_menu_image(richMenuId :: String.t(), opts :: keyword) ::
          {:ok, String.t()} | :error
  ...
  **Content Types**: `*/*`
  ...
  """
  @spec set_rich_menu_image(richMenuId :: String.t(), body :: String.t(), opts :: keyword) ::
          :ok | :error
